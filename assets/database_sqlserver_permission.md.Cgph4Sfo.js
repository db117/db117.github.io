import{_ as a,o as e,c as n,ah as t}from"./chunks/framework.CZP_9SSd.js";const m=JSON.parse('{"title":"权限相关","description":"","frontmatter":{"title":"权限相关"},"headers":[],"relativePath":"database/sqlserver/permission.md","filePath":"database/sqlserver/permission.md","lastUpdated":1779088789000}'),p={name:"database/sqlserver/permission.md"};function l(i,s,r,d,u,c){return e(),n("div",null,[...s[0]||(s[0]=[t(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h3 id="授予权限" tabindex="-1">授予权限 <a class="header-anchor" href="#授予权限" aria-label="Permalink to &quot;授予权限&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>-- 把Student表查询权限授予userName</span></span>
