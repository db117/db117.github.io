import{_ as s,o as n,c as a,R as p}from"./chunks/framework.H_1uJR_t.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ops/nginx/nginx-https.md","filePath":"ops/nginx/nginx-https.md","lastUpdated":1703658702000}'),e={name:"ops/nginx/nginx-https.md"},l=p(`<h4 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#user  nobody;</span></span>
...
<span class="line"><span>		server_name *.db117.top;</span></span>
<span class="line"><span>		return 301 https://$http_host$request_uri;</span></span>
<span class="line"><span>	}</span></span></code></pre></div>`,4),t=[l];function i(c,o,r,_,h,d){return n(),a("div",null,t)}const m=s(e,[["render",i]]);export{g as __pageData,m as default};
