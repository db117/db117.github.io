...
<span class="line"><span style="color:#A6ACCD;">          match: after                                # 合并到上一行的末尾, 为了error等日志</span></span>
<span class="line"><span style="color:#A6ACCD;">          max_lines: 1000                             # 最大的行数</span></span>
<span class="line"><span style="color:#A6ACCD;">          timeout: 30s                                # 如果在规定的时候没有新的日志事件就不等待后面的日志</span></span></code></pre></div>`,12),p=[l];function o(c,i,r,C,A,d){return n(),a("div",null,p)}const y=s(t,[["render",o]]);export{h as __pageData,y as default};
