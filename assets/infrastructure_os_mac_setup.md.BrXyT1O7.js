import{_ as s,o as n,c as p,ah as e}from"./chunks/framework.BM5zFche.js";const u=JSON.parse('{"title":"各种环境","description":"","frontmatter":{"title":"各种环境"},"headers":[],"relativePath":"infrastructure/os/mac/setup.md","filePath":"infrastructure/os/mac/setup.md","lastUpdated":1784602594000}'),t={name:"infrastructure/os/mac/setup.md"};function l(i,a,c,o,r,_){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h3 id="jdk动态配置" tabindex="-1">jdk动态配置 <a class="header-anchor" href="#jdk动态配置" aria-label="Permalink to &quot;jdk动态配置&quot;">​</a></h3><blockquote><p>根据需要动态配置jdk</p><p>需要先把jdk文件解压到mac默认的文件夹下（/Library/Java/JavaVirtualMachines）</p><p>/usr/libexec/java_home -v &lt;版本号&gt; 是打印指定版本号绝对路径</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># jdk设置</span></span>
...
<span class="line"><span>alias jdk15=&quot;export JAVA_HOME=$JAVA_15_HOME&quot;</span></span></code></pre></div>`,3)])])}const A=s(t,[["render",l]]);export{u as __pageData,A as default};
