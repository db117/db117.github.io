import{_ as n,o as a,c as p,ah as l}from"./chunks/framework.CZP_9SSd.js";const h=JSON.parse('{"title":"Reactor","description":"","frontmatter":{"title":"Reactor"},"headers":[],"relativePath":"java/util/reactor.md","filePath":"java/util/reactor.md","lastUpdated":1778064368000}'),e={name:"java/util/reactor.md"};function i(t,s,c,o,r,d){return a(),p("div",null,[...s[0]||(s[0]=[l(`<blockquote><p><a href="https://projectreactor.io/" target="_blank" rel="noreferrer">https://projectreactor.io/</a></p><p><a href="https://github.com/reactor" target="_blank" rel="noreferrer">https://github.com/reactor</a></p></blockquote><h3 id="创建序列" tabindex="-1">创建序列 <a class="header-anchor" href="#创建序列" aria-label="Permalink to &quot;创建序列&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 生成固定的序列</span></span>
