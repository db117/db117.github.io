import{_ as n,C as e,o as p,c as r,E as o,ah as t}from"./chunks/framework.CZP_9SSd.js";const g=JSON.parse('{"title":"Ubuntu相关","description":"","frontmatter":{"title":"Ubuntu相关"},"headers":[],"relativePath":"os/linux/Ubuntu.md","filePath":"os/linux/Ubuntu.md","lastUpdated":1779088789000}'),i={name:"os/linux/Ubuntu.md"};function l(c,a,d,h,u,m){const s=e("TOC");return p(),r("div",null,[o(s),a[0]||(a[0]=t(`<h4 id="安装chrome" tabindex="-1">安装Chrome <a class="header-anchor" href="#安装chrome" aria-label="Permalink to &quot;安装Chrome&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 安装依赖</span></span>
