import{_ as s,o as a,c as n,S as l}from"./chunks/framework.1603d207.js";const D=JSON.parse('{"title":"redis","description":"","frontmatter":{"title":"redis"},"headers":[],"relativePath":"database/redis/index.md","filePath":"database/redis/index.md","lastUpdated":1692600405000}'),p={name:"database/redis/index.md"},e=l(`<blockquote><p><a href="http://www.redis.cn/" target="_blank" rel="noreferrer">CRUG网站 (redis.cn)</a></p></blockquote><h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h4 id="连接服务" tabindex="-1">连接服务 <a class="header-anchor" href="#连接服务" aria-label="Permalink to &quot;连接服务&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 直接输入密码</span></span>
...
<span class="line"><span style="color:#A6ACCD;">quit</span></span></code></pre></div><h4 id="锁" tabindex="-1">锁 <a class="header-anchor" href="#锁" aria-label="Permalink to &quot;锁&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">SET &lt;key&gt;  &lt;value&gt; NX EX &lt;max-lock-time&gt;</span></span></code></pre></div><h4 id="字符串" tabindex="-1">字符串 <a class="header-anchor" href="#字符串" aria-label="Permalink to &quot;字符串&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="删除数据" tabindex="-1">删除数据 <a class="header-anchor" href="#删除数据" aria-label="Permalink to &quot;删除数据&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 使用 UNLINK 异步删除</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">done</span></span></code></pre></div>`,13),t=[e];function o(c,r,i,C,A,d){return a(),n("div",null,t)}const h=s(p,[["render",o]]);export{D as __pageData,h as default};
