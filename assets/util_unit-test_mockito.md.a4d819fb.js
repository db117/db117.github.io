...
<span class="line"><span style="color:#A6ACCD;">        assertThat(mock.objectReturningMethodNoArgs()).isEqualTo(&quot;qix&quot;);</span></span></code></pre></div></li></ul></li><li><p>​ doThrow</p><ul><li>同 doReturn</li></ul></li><li><p>doNothing</p><ul><li><p>常见于<code>void</code>返回值的方法，模拟一次调用。</p></li><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">doNothing().</span></span>
<span class="line"><span style="color:#A6ACCD;">   doThrow(new RuntimeException())</span></span>
...
<span class="line"><span style="color:#A6ACCD;">   verify(mock, after(100).never()).someMethod();</span></span></code></pre></div></li></ul></li><li><p>timeout</p><ul><li><p>使用方式和<code>after</code>一样</p></li><li><p>但是timeout再满足条件后直接返回<code>success</code>，但是<code>after</code>需要等到时间结束才返回</p></li><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">//1.</span></span>
...
</code></pre>`,17),t=[o];function p(i,c,r,u,d,C){return a(),l("div",null,t)}const m=s(e,[["render",p]]);export{h as __pageData,m as default};
