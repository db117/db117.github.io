import{_ as a,c as s,o as n,a7 as e}from"./chunks/framework.DlLVvJYm.js";const v=JSON.parse('{"title":"查询语法","description":"","frontmatter":{"title":"查询语法"},"headers":[],"relativePath":"ops/prometheus/query.md","filePath":"ops/prometheus/query.md","lastUpdated":1715260831000}'),t={name:"ops/prometheus/query.md"},p=e(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h4 id="标签筛选" tabindex="-1">标签筛选 <a class="header-anchor" href="#标签筛选" aria-label="Permalink to &quot;标签筛选&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 正则匹配 lable</span></span>
...
<span class="line"><span>topk(5, http_requests_total)</span></span></code></pre></div><h2 id="内置函数" tabindex="-1">内置函数 <a class="header-anchor" href="#内置函数" aria-label="Permalink to &quot;内置函数&quot;">​</a></h2><p>瞬时向量</p><ul><li><p>instant-vector abs(instant-vector)：绝对值</p></li><li><p>instant-vector sqrt(instant-vector))：平方根</p></li><li><p>instant-vector exp(instant-vector )：指数计算</p></li><li><p>instant-vector ln(instant-vector )：自然对数</p></li><li><p>instant-vector ceil(instant-vector )：向上取整</p></li><li><p>instant-vector floor(instant-vector )：向下取整</p></li><li><p>instant-vector round(instant-vector )：四舍五入取整</p></li><li><p>absent(v instant-vector):</p><blockquote><p>有值返回 空向量</p><p>没有值，则返回标签名称的时间序列 并返回值为1</p></blockquote></li><li><p>clamp(v instant-vector, min scalar, max scalar)</p><blockquote><p>使瞬时向量在设定的区间内,即小于最小值取最小值 大于最大值取最大值</p></blockquote></li><li><p>clamp_max(): 同clamp</p></li><li><p>clamp_min(): 同clamp</p></li></ul><p>范围向量</p><ul><li><p>instant-vector delta(range-vector)：计算区间向量里最大最小的差值</p></li><li><p>instant-vector increase(range-vector)：计算区间向量里最后一个值和第一个值的差值</p></li><li><p>instant-vector rate(range-vector)：计算区间向量里的平均增长率</p></li><li><p>instant-vector irate(range-vector)：计算区间向量里的瞬时增长率</p></li><li><p>instant-vector avg_over_time(range-vector)：指定间隔内所有点的平均值。</p></li><li><p>instant-vector min_over_time(range-vector)：指定间隔中所有点的最小值。</p></li><li><p>instant-vector max_over_time(range-vector)：指定间隔内所有点的最大值。</p></li><li><p>instant-vector sum_over_time(range-vector)：指定时间间隔内所有值的总和。</p></li><li><p>absent_over_time(v range-vector)</p><blockquote><p>与absent类型,不过入参是范围向量</p></blockquote></li><li><p>instant-vector changes(v range-vector): 返回这个区间向量内每个样本数据值变化的次数</p></li></ul>`,37),l=[p];function i(o,c,r,u,d,h){return n(),s("div",null,l)}const m=a(t,[["render",i]]);export{v as __pageData,m as default};
