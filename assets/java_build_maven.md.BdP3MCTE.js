import{_ as n,o as s,c as t,ah as p}from"./chunks/framework.BM5zFche.js";const u=JSON.parse('{"title":"maven","description":"","frontmatter":{"title":"maven"},"headers":[],"relativePath":"java/build/maven.md","filePath":"java/build/maven.md","lastUpdated":1783680024000}'),e={name:"java/build/maven.md"};function l(i,a,c,g,o,r){return s(),t("div",null,[...a[0]||(a[0]=[p(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#	打包跳过编译失败</span></span>
