import{_ as s,c as a,o as n,a as l}from"./app.bab73cad.js";const y=JSON.parse('{"title":"supervisord使用","description":"","frontmatter":{"title":"supervisord使用"},"headers":[{"level":3,"title":"简介","slug":"简介","link":"#简介","children":[]},{"level":3,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":3,"title":"命令","slug":"命令","link":"#命令","children":[]},{"level":3,"title":"配置文件","slug":"配置文件","link":"#配置文件","children":[]}],"relativePath":"ops/supervisord.md","lastUpdated":1677655177000}'),p={name:"ops/supervisord.md"},e=l(`<h3 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-hidden="true">#</a></h3><p><a href="https://github.com/Supervisor/supervisor" target="_blank" rel="noreferrer">GitHub</a></p><p><a href="https://pypi.org/project/supervisor/" target="_blank" rel="noreferrer">pypi</a></p><p><a href="http://supervisord.org/index.html" target="_blank" rel="noreferrer">官网</a></p><h3 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h3><blockquote><p>安装</p></blockquote><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;"># pip</span></span>
