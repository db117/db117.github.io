import{_ as n,C as e,o as r,c as p,E as t,ah as o}from"./chunks/framework.BM5zFche.js";const g=JSON.parse('{"title":"Ubuntu 相关","description":"","frontmatter":{"title":"Ubuntu 相关"},"headers":[],"relativePath":"infrastructure/os/linux/ubuntu.md","filePath":"infrastructure/os/linux/ubuntu.md","lastUpdated":1784602594000}'),i={name:"infrastructure/os/linux/ubuntu.md"};function l(c,a,d,u,h,m){const s=e("TOC");return r(),p("div",null,[t(s),a[0]||(a[0]=o(`<h4 id="安装chrome" tabindex="-1">安装Chrome <a class="header-anchor" href="#安装chrome" aria-label="Permalink to &quot;安装Chrome&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 安装依赖</span></span>
