import{_ as s,c as a,o as n,a as l}from"./app.fc437e13.js";const g=JSON.parse('{"title":"gradle","description":"","frontmatter":{"title":"gradle"},"headers":[{"level":2,"title":"gradle","slug":"gradle","link":"#gradle","children":[{"level":3,"title":"gradle代理","slug":"gradle代理","link":"#gradle代理","children":[]},{"level":3,"title":"跳过测试","slug":"跳过测试","link":"#跳过测试","children":[]},{"level":3,"title":"lombok","slug":"lombok","link":"#lombok","children":[]}]}],"relativePath":"util/gradle/README.md","lastUpdated":1677491985000}'),e={name:"util/gradle/README.md"},o=l(`<h2 id="gradle" tabindex="-1">gradle <a class="header-anchor" href="#gradle" aria-hidden="true">#</a></h2><h3 id="gradle代理" tabindex="-1">gradle代理 <a class="header-anchor" href="#gradle代理" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 构建时添加jvm参数</span></span>
