import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"Reactor","description":"","frontmatter":{"title":"Reactor"},"headers":[],"relativePath":"java/tools/reactor.md","filePath":"java/tools/reactor.md","lastUpdated":1787138032000}`),a={name:`java/tools/reactor.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<blockquote><p><a href="https://projectreactor.io/" target="_blank" rel="noreferrer">https://projectreactor.io/</a></p><p><a href="https://github.com/reactor" target="_blank" rel="noreferrer">https://github.com/reactor</a></p></blockquote><h3 id="创建序列" tabindex="-1">创建序列 <a class="header-anchor" href="#创建序列" aria-label="Permalink to “创建序列”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 生成固定的序列</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># 通过回调方法生成</span></span>
...
<span class="line"><span>		    });</span></span></code></pre></div><h3 id="改变序列" tabindex="-1">改变序列 <a class="header-anchor" href="#改变序列" aria-label="Permalink to “改变序列”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 1 变 1</span></span>
...
<span class="line"><span>expand();</span></span></code></pre></div><h3 id="查看序列" tabindex="-1">查看序列 <a class="header-anchor" href="#查看序列" aria-label="Permalink to “查看序列”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 每一个元素都查看</span></span>
...
<span class="line"><span>doFinally();</span></span></code></pre></div><h3 id="过滤元素" tabindex="-1">过滤元素 <a class="header-anchor" href="#过滤元素" aria-label="Permalink to “过滤元素”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 同步过滤元素</span></span>
...
<span class="line"><span>sample();</span></span></code></pre></div><h3 id="处理异常" tabindex="-1">处理异常 <a class="header-anchor" href="#处理异常" aria-label="Permalink to “处理异常”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 触发异常</span></span>
...
<span class="line"><span>retryWhen();</span></span></code></pre></div><h3 id="拆分流" tabindex="-1">拆分流 <a class="header-anchor" href="#拆分流" aria-label="Permalink to “拆分流”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 按照窗口大小，或时间进行拆分</span></span>
...
<span class="line"><span>bufferWhile():</span></span></code></pre></div>`,13)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};