import{_ as s,o as a,c as n,V as e}from"./chunks/framework.7cbf217e.js";const m=JSON.parse('{"title":"java 时间工具","description":"","frontmatter":{"title":"java 时间工具"},"headers":[],"relativePath":"java/util/dateUtil.md","filePath":"java/util/dateUtil.md","lastUpdated":1686036827000}'),l={name:"java/util/dateUtil.md"},p=e(`<h3 id="时间格式对照表" tabindex="-1">时间格式对照表 <a class="header-anchor" href="#时间格式对照表" aria-label="Permalink to &quot;时间格式对照表&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Symbol  Meaning                     Presentation      Examples</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    {       reserved for future use</span></span>
<span class="line"><span style="color:#A6ACCD;">    }       reserved for future use</span></span></code></pre></div><h3 id="datetimeformatter相关" tabindex="-1">DateTimeFormatter相关 <a class="header-anchor" href="#datetimeformatter相关" aria-label="Permalink to &quot;DateTimeFormatter相关&quot;">​</a></h3><p>常规使用</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">DateTimeFormatter formatter = DateTimeFormatter.ofPattern(&quot;yyyy-MM-dd HH:mm&quot;);</span></span></code></pre></div><p>复杂格式实现</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 时间格式非常规</span></span>
...
<span class="line"><span style="color:#A6ACCD;">            .toFormatter();</span></span></code></pre></div>`,7),o=[p];function t(r,c,i,A,C,y){return a(),n("div",null,o)}const D=s(l,[["render",t]]);export{m as __pageData,D as default};
