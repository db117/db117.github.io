import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"query_string","description":"","frontmatter":{"title":"query_string"},"headers":[],"relativePath":"infrastructure/ops/logging/elasticsearch/query-string.md","filePath":"infrastructure/ops/logging/elasticsearch/query-string.md","lastUpdated":1786609246000}`),a={name:`infrastructure/ops/logging/elasticsearch/query-string.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<blockquote><p><a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-query-string-query.html#query-string-top-level-params" target="_blank" rel="noreferrer">https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-query-string-query.html#query-string-top-level-params</a></p><p>kibana 中查询使用的就是这个。</p></blockquote><h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to “备忘单”">​</a></h2><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 字段 field 包含 active</span></span>
...
<span class="line"><span>date:&lt;2024-01-01</span></span></code></pre></div><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to “语法”">​</a></h2><h4 id="查询字段" tabindex="-1">查询字段 <a class="header-anchor" href="#查询字段" aria-label="Permalink to “查询字段”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 存在 title 字段</span></span>
