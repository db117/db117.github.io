import{_ as s,c as n,o as a,a as e}from"./app.409a788d.js";const m=JSON.parse('{"title":"java 时间工具","description":"","frontmatter":{"title":"java 时间工具"},"headers":[{"level":3,"title":"时间格式对照表","slug":"时间格式对照表","link":"#时间格式对照表","children":[]},{"level":3,"title":"DateTimeFormatter相关","slug":"datetimeformatter相关","link":"#datetimeformatter相关","children":[]}],"relativePath":"java/util/dateUtil.md","lastUpdated":1677578323000}'),l={name:"java/util/dateUtil.md"},p=e(`<h3 id="时间格式对照表" tabindex="-1">时间格式对照表 <a class="header-anchor" href="#时间格式对照表" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">	Symbol  Meaning                     Presentation      Examples</span></span>
