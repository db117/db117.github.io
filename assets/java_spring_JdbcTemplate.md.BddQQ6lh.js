import{_ as a,c as s,o as e,a5 as n}from"./chunks/framework.CDo-_4TQ.js";const b=JSON.parse('{"title":"JdbcTemplate","description":"","frontmatter":{"title":"JdbcTemplate"},"headers":[],"relativePath":"java/spring/JdbcTemplate.md","filePath":"java/spring/JdbcTemplate.md","lastUpdated":1721631524000}'),t={name:"java/spring/JdbcTemplate.md"},p=n(`<h3 id="常规使用" tabindex="-1">常规使用 <a class="header-anchor" href="#常规使用" aria-label="Permalink to &quot;常规使用&quot;">​</a></h3><h5 id="查询出对象" tabindex="-1">查询出对象 <a class="header-anchor" href="#查询出对象" aria-label="Permalink to &quot;查询出对象&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
...
<span class="line"><span>insert.execute(new BeanPropertySqlParameterSource(new Person()));</span></span></code></pre></div>`,7),l=[p];function o(i,r,c,d,u,h){return e(),s("div",null,l)}const g=a(t,[["render",o]]);export{b as __pageData,g as default};
