import{_ as s,c as n,o as a,a as e}from"./app.fc437e13.js";const d=JSON.parse('{"title":"kube-prometheus","description":"","frontmatter":{"title":"kube-prometheus"},"headers":[{"level":2,"title":"简单使用","slug":"简单使用","link":"#简单使用","children":[{"level":3,"title":"前置条件","slug":"前置条件","link":"#前置条件","children":[]},{"level":3,"title":"使用","slug":"使用","link":"#使用","children":[]},{"level":3,"title":"注意事项","slug":"注意事项","link":"#注意事项","children":[]}]},{"level":2,"title":"自定义配置","slug":"自定义配置","link":"#自定义配置","children":[]}],"relativePath":"ops/prometheus/kube-prometheus.md","lastUpdated":1677491985000}'),l={name:"ops/prometheus/kube-prometheus.md"},p=e(`<blockquote><p><a href="https://github.com/prometheus-operator/kube-prometheus" target="_blank" rel="noreferrer">kube-prometheus</a></p><p>该项目使用<code>jsonnet</code>编写，上手有一定难度。</p><p>主要是在 k8s 中部署监控的一系列工具。</p><ul><li><a href="https://github.com/prometheus-operator/prometheus-operator" target="_blank" rel="noreferrer">Prometheus Operator</a></li><li>高可用 <a href="https://prometheus.io/" target="_blank" rel="noreferrer">Prometheus</a></li><li>高可用 <a href="https://github.com/prometheus/alertmanager" target="_blank" rel="noreferrer">Alertmanager</a></li><li><a href="https://github.com/prometheus/node_exporter" target="_blank" rel="noreferrer">Prometheus node-exporter</a></li><li><a href="https://github.com/DirectXMan12/k8s-prometheus-adapter" target="_blank" rel="noreferrer">Prometheus Adapter for Kubernetes Metrics APIs</a></li><li><a href="https://github.com/kubernetes/kube-state-metrics" target="_blank" rel="noreferrer">kube-state-metrics</a></li><li><a href="https://grafana.com/" target="_blank" rel="noreferrer">Grafana</a></li></ul></blockquote><h2 id="简单使用" tabindex="-1">简单使用 <a class="header-anchor" href="#简单使用" aria-hidden="true">#</a></h2><blockquote><p>对默认的没有特别的要求情况下可以直接使用</p></blockquote><h3 id="前置条件" tabindex="-1">前置条件 <a class="header-anchor" href="#前置条件" aria-hidden="true">#</a></h3><ul><li>go环境</li><li>安装jb(jsonnet-bundler) <ul><li>使用go安装<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">go get github.com/jsonnet-bundler/jsonnet-bundler/cmd/jb</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li>使用brewhome安装<div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">brew</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">install</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">jsonnet-bundler</span></span>
<span class="line"></span></code></pre></div></li></ul></li><li>gojsontoyaml安装<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">go get github.com/brancz/gojsontoyaml</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ul><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-hidden="true">#</a></h3><ul><li><p>修改配置文件</p><blockquote><p>example.jsonnet</p></blockquote></li><li><p>生成文件</p><blockquote><p>运行<code>./build.sh example.jsonnet</code> 会在<code>manifests</code>目录生成配置文件</p></blockquote></li><li><p>格式化.jsonnet</p><blockquote><p>需要安装jsonnetfmt</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">  git clone git@github.com:google/go-jsonnet.git</span></span>
<span class="line"><span style="color:#A6ACCD;">  cd go-jsonnet</span></span>
<span class="line"><span style="color:#A6ACCD;">  go build ./cmd/jsonnetfmt</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><blockquote><p>使用vsCode的<code>jsonnet Formatter</code>插件 或者使用下面代码直接格式化</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"> jsonnetfmt --indent 2 --max-blank-lines 2 --sort-imports --string-style s --comment-style s -i test.jsonnet  </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ul><h3 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-hidden="true">#</a></h3><ul><li>vendor目录是jb生成的</li><li>除配置文件都是从github上面copy的不需要修改直接<code>jb update</code></li></ul><h2 id="自定义配置" tabindex="-1">自定义配置 <a class="header-anchor" href="#自定义配置" aria-hidden="true">#</a></h2><blockquote><p>默认的配置,不满足的情况下。</p><p>实际上都是对生成的文件进行修改，如果不想写配置文件，可以直接对生成的文件进行修改使用。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">local filter = {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">{ [&#39;prometheus-adapter-&#39; + name]: kp.prometheusAdapter[name] for name in std.objectFields(kp.prometheusAdapter) }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,12),o=[p];function t(r,c,i,C,A,u){return a(),n("div",null,o)}const y=s(l,[["render",t]]);export{d as __pageData,y as default};
