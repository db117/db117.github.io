import{_ as s,o as a,c as n,U as e}from"./chunks/framework.a49774c2.js";const m=JSON.parse('{"title":"java 时间工具","description":"","frontmatter":{"title":"java 时间工具"},"headers":[],"relativePath":"java/util/dateUtil.md","filePath":"java/util/dateUtil.md","lastUpdated":1690184541000}'),l={name:"java/util/dateUtil.md"},p=e(`<h3 id="时间格式对照表" tabindex="-1">时间格式对照表 <a class="header-anchor" href="#时间格式对照表" aria-label="Permalink to &quot;时间格式对照表&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Symbol  Meaning                     Presentation      Examples</span></span>
