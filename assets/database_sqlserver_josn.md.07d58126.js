import{_ as s,c as n,o as a,a as t}from"./app.a840672a.js";const y=JSON.parse('{"title":"json 相关","description":"","frontmatter":{"title":"json 相关"},"headers":[{"level":3,"title":"将查询结果格式化为 JSON","slug":"将查询结果格式化为-json","link":"#将查询结果格式化为-json","children":[]},{"level":3,"title":"获取 json 数据","slug":"获取-json-数据","link":"#获取-json-数据","children":[]},{"level":3,"title":"修改 json 的值","slug":"修改-json-的值","link":"#修改-json-的值","children":[]}],"relativePath":"database/sqlserver/josn.md","lastUpdated":1678341619000}'),l={name:"database/sqlserver/josn.md"},o=t(`<h1 id="json-基本操作" tabindex="-1">JSON 基本操作 <a class="header-anchor" href="#json-基本操作" aria-hidden="true">#</a></h1><blockquote><p><a href="https://docs.microsoft.com/zh-cn/sql/relational-databases/json/json-data-sql-server?view=sql-server-ver15" target="_blank" rel="noreferrer">使用 JSON 数据 - SQL Server | Microsoft Docs</a></p></blockquote><h3 id="将查询结果格式化为-json" tabindex="-1">将查询结果格式化为 JSON <a class="header-anchor" href="#将查询结果格式化为-json" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">SELECT name, surname  </span></span>
