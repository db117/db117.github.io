import{_ as n,o as s,c as a,R as p}from"./chunks/framework.H_1uJR_t.js";const u=JSON.parse('{"title":"二分算法","description":"","frontmatter":{"title":"二分算法"},"headers":[],"relativePath":"algorithm/binarySearch.md","filePath":"algorithm/binarySearch.md","lastUpdated":1699241780000}'),l={name:"algorithm/binarySearch.md"},e=p(`<h3 id="精确查找" tabindex="-1">精确查找 <a class="header-anchor" href="#精确查找" aria-label="Permalink to &quot;精确查找&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
