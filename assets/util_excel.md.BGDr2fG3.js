import{_ as a,c as n,a3 as p,o as e}from"./chunks/framework.lVUbth6I.js";const r=JSON.parse('{"title":"Excel 公式","description":"","frontmatter":{"title":"Excel 公式"},"headers":[],"relativePath":"util/excel.md","filePath":"util/excel.md"}'),l={name:"util/excel.md"};function t(i,s,o,c,u,d){return e(),n("div",null,s[0]||(s[0]=[p(`<h3 id="文本" tabindex="-1">文本 <a class="header-anchor" href="#文本" aria-label="Permalink to &quot;文本&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 字符串拼接</span></span>
