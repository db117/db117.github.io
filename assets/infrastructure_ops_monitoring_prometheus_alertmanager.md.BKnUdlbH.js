import{Q as e,gt as t,nt as n,s as r,tt as i}from"./chunks/framework.BqU7tCwc.js";var a=JSON.parse(`{"title":"alertmanager","description":"","frontmatter":{"title":"alertmanager"},"headers":[],"relativePath":"infrastructure/ops/monitoring/prometheus/alertmanager.md","filePath":"infrastructure/ops/monitoring/prometheus/alertmanager.md","lastUpdated":1784883183000}`),o={name:`infrastructure/ops/monitoring/prometheus/alertmanager.md`};function s(r,a,o,s,c,l){return t(),i(`div`,null,[...a[0]||=[e(`blockquote`,null,[e(`p`,null,`Prometheus 中的报警发送给 alertmanager . 在通过分组,过滤,抑制后发送给不同的通知接收器的列表`)],-1),e(`iframe`,{id:`embed_dom`,name:`embed_dom`,frameborder:`0`,style:{display:`block`,width:`725px`,height:`245px`},src:`https://www.processon.com/embed/60e579a51e08530a5074c834`},null,-1),n(`<h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to “配置”">​</a></h2><h3 id="通用配置" tabindex="-1">通用配置 <a class="header-anchor" href="#通用配置" aria-label="Permalink to “通用配置”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>global:</span></span>
