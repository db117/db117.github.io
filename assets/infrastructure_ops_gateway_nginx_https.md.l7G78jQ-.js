import{_ as n,o as a,c as p,ah as e}from"./chunks/framework.BM5zFche.js";const d=JSON.parse('{"title":"Nginx HTTPS","description":"","frontmatter":{"title":"Nginx HTTPS"},"headers":[],"relativePath":"infrastructure/ops/gateway/nginx/https.md","filePath":"infrastructure/ops/gateway/nginx/https.md","lastUpdated":1784602594000}'),l={name:"infrastructure/ops/gateway/nginx/https.md"};function t(i,s,c,r,o,h){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="nginx-https" tabindex="-1">Nginx HTTPS <a class="header-anchor" href="#nginx-https" aria-label="Permalink to &quot;Nginx HTTPS&quot;">​</a></h1><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#user  nobody;</span></span>
...
<span class="line"><span>		server_name *.db117.top;</span></span>
<span class="line"><span>		return 301 https://$http_host$request_uri;</span></span>
<span class="line"><span>	}</span></span></code></pre></div>`,5)])])}const u=n(l,[["render",t]]);export{d as __pageData,u as default};
