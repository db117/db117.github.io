import{_ as s,o as a,c as n,R as p}from"./chunks/framework.H_1uJR_t.js";const m=JSON.parse('{"title":"gradle","description":"","frontmatter":{"title":"gradle"},"headers":[],"relativePath":"util/gradle/index.md","filePath":"util/gradle/index.md","lastUpdated":1703658702000}'),e={name:"util/gradle/index.md"},l=p(`<h2 id="gradle" tabindex="-1">gradle <a class="header-anchor" href="#gradle" aria-label="Permalink to &quot;gradle&quot;">​</a></h2><h2 id="gradle配置国内镜像" tabindex="-1">gradle配置国内镜像 <a class="header-anchor" href="#gradle配置国内镜像" aria-label="Permalink to &quot;gradle配置国内镜像&quot;">​</a></h2><p>对所有项目生效，在\${USER_HOME}/.gradle/下创建init.gradle文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>allprojects{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,10),t=[l];function o(i,r,c,d,h,u){return a(),n("div",null,t)}const _=s(e,[["render",o]]);export{m as __pageData,_ as default};
