...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="awk" tabindex="-1">awk <a class="header-anchor" href="#awk" aria-hidden="true">#</a></h2><p>常用参数</p><blockquote><ul><li>-F fs or --field-separator fs 指定输入文件折分隔符，fs是一个字符串或者是一个正则表达式，如-F:。</li><li>-v var=value or --asign var=value 赋值一个用户定义变量。</li><li>-f scripfile or --file scriptfile 从脚本文件中读取awk命令。</li><li>-W version or --version 打印bug报告信息的版本。</li></ul><hr></blockquote><p>实例</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 行匹配语句 awk &#39;&#39; 只能用单引号</span></span>
