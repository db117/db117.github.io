import{_ as a,c as s,o as e,a as n}from"./app.a840672a.js";const h=JSON.parse('{"title":"JdbcTemplate","description":"","frontmatter":{"title":"JdbcTemplate"},"headers":[{"level":3,"title":"常规使用","slug":"常规使用","link":"#常规使用","children":[{"level":5,"title":"查询出对象","slug":"查询出对象","link":"#查询出对象","children":[]},{"level":5,"title":"参数 in","slug":"参数-in","link":"#参数-in","children":[]},{"level":5,"title":"简单对象保存","slug":"简单对象保存","link":"#简单对象保存","children":[]}]}],"relativePath":"java/spring/JdbcTemplate.md","lastUpdated":1678341619000}'),l={name:"java/spring/JdbcTemplate.md"},t=n(`<h3 id="常规使用" tabindex="-1">常规使用 <a class="header-anchor" href="#常规使用" aria-hidden="true">#</a></h3><h5 id="查询出对象" tabindex="-1">查询出对象 <a class="header-anchor" href="#查询出对象" aria-hidden="true">#</a></h5><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,7),p=[t];function o(r,c,i,d,C,u){return e(),s("div",null,p)}const m=a(l,[["render",o]]);export{h as __pageData,m as default};
