import{_ as a,o as p,c as t,j as s,ah as l}from"./chunks/framework.BM5zFche.js";const h=JSON.parse('{"title":"alertmanager","description":"","frontmatter":{"title":"alertmanager"},"headers":[],"relativePath":"ops/monitoring/prometheus/alertmanager.md","filePath":"ops/monitoring/prometheus/alertmanager.md","lastUpdated":1783680024000}'),e={name:"ops/monitoring/prometheus/alertmanager.md"};function i(c,n,o,r,g,u){return p(),t("div",null,[...n[0]||(n[0]=[s("blockquote",null,[s("p",null,"Prometheus 中的报警发送给 alertmanager . 在通过分组,过滤,抑制后发送给不同的通知接收器的列表")],-1),s("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60e579a51e08530a5074c834"},null,-1),l(`<h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h2><h3 id="通用配置" tabindex="-1">通用配置 <a class="header-anchor" href="#通用配置" aria-label="Permalink to &quot;通用配置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>global:</span></span>
...
<span class="line"><span>    ...</span></span>
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,18)])])}const _=a(e,[["render",i]]);export{h as __pageData,_ as default};
