import{_ as n,o as s,c as a,R as p}from"./chunks/framework.ANQB9ulZ.js";const u=JSON.parse('{"title":"二分算法","description":"","frontmatter":{"title":"二分算法"},"headers":[],"relativePath":"algorithm/binarySearch.md","filePath":"algorithm/binarySearch.md","lastUpdated":1703843411000}'),l={name:"algorithm/binarySearch.md"},e=p(`<h3 id="精确查找" tabindex="-1">精确查找 <a class="header-anchor" href="#精确查找" aria-label="Permalink to &quot;精确查找&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="找等于目标值的最小索引" tabindex="-1">找等于目标值的最小索引 <a class="header-anchor" href="#找等于目标值的最小索引" aria-label="Permalink to &quot;找等于目标值的最小索引&quot;">​</a></h3><p>两种写法，主要区别是 <code>while</code> 判断条件。</p><p>当 <code>left&lt;=right</code> 时结束时 <code>left</code> 不等于 <code>right</code>。<code>left</code> 有越界风险。需要判断。</p><p>当 <code>left&lt;right</code>时结束时 <code>left</code> 等于 <code>right</code>。无需判断是否越界。但是需要判断是否找到目标值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="找等于目标值的最大索引" tabindex="-1">找等于目标值的最大索引 <a class="header-anchor" href="#找等于目标值的最大索引" aria-label="Permalink to &quot;找等于目标值的最大索引&quot;">​</a></h3><p>区别同上</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>    // 需要判断是否找到</span></span>
<span class="line"><span>    return nums[right] == target ? right : -1;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="找小于目标的最大值" tabindex="-1">找小于目标的最大值 <a class="header-anchor" href="#找小于目标的最大值" aria-label="Permalink to &quot;找小于目标的最大值&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>    return nums[right] &lt; target ? right : -1;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="找大于目标的最小值" tabindex="-1">找大于目标的最小值 <a class="header-anchor" href="#找大于目标的最小值" aria-label="Permalink to &quot;找大于目标的最小值&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>    return nums[right] &gt; target ? right : -1;</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,14),i=[e];function t(c,r,h,g,d,o){return s(),a("div",null,i)}const f=n(l,[["render",t]]);export{u as __pageData,f as default};
