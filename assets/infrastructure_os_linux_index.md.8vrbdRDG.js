import{_ as a,o as n,c as p,ah as e}from"./chunks/framework.BM5zFche.js";const u=JSON.parse('{"title":"linux","description":"","frontmatter":{"title":"linux"},"headers":[],"relativePath":"infrastructure/os/linux/index.md","filePath":"infrastructure/os/linux/index.md","lastUpdated":1784602594000}'),l={name:"infrastructure/os/linux/index.md"};function t(i,s,c,d,o,r){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h3 id="权限" tabindex="-1">权限 <a class="header-anchor" href="#权限" aria-label="Permalink to &quot;权限&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 将文件 file1.txt 设为所有人皆可读取</span></span>
