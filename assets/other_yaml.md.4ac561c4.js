...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>omap</p><blockquote><p>键: 值对的有序序列，无重复值。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># Explicitly typed ordered map (dictionary).</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>pairs</p><blockquote><p>键: 值对的有序序列，允许重复。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># Explicitly typed pairs.</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>set</p><blockquote><p>非等值的无序集合。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># Explicitly typed set.</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>seq</p><blockquote><p>表示一个从零开始的连续整数索引的集合。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Block style: !!seq</span></span>
<span class="line"><span style="color:#A6ACCD;">- Clark Evans</span></span>
<span class="line"><span style="color:#A6ACCD;">- Ingy döt Net</span></span>
<span class="line"><span style="color:#A6ACCD;">- Oren Ben-Kiki</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">Flow style: !!seq [ Clark Evans, Ingy döt Net, Oren Ben-Kiki ]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>str</p><blockquote><p>表示 Unicode 字符串,由零个或多个 Unicode 字符组成的序列。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Block style: !!str |-</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>bool</p><blockquote><p>表示一个 true/false 值</p><p>true | True | TRUE | false | False | FALSE</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">YAML is a superset of JSON: !!bool true</span></span>
<span class="line"><span style="color:#A6ACCD;">Pluto is a planet: !!bool false</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>int</p><blockquote><p>整数</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">negative: !!int -12</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>binary</p><blockquote><p>一个由零个或多个八位元组成的序列(8位值)。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">canonical: !!binary &quot;\\</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>merge</p><blockquote><p>指定一个或多个要与当前映射合并的映射。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">---</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  x: 1</span></span>
<span class="line"><span style="color:#A6ACCD;">  label: center/big</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>timestamp</p><blockquote><p>时间</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"> 匹配:</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ul>`,8),o=[e];function t(c,i,A,r,C,y){return n(),a("div",null,o)}const d=s(p,[["render",t]]);export{u as __pageData,d as default};
