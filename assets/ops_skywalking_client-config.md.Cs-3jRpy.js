import{_ as n,c as s,o as a,a8 as p}from"./chunks/framework.DWDnyA0p.js";const m=JSON.parse('{"title":"客户端配置","description":"","frontmatter":{"title":"客户端配置"},"headers":[],"relativePath":"ops/skywalking/client-config.md","filePath":"ops/skywalking/client-config.md","lastUpdated":1712806971000}'),e={name:"ops/skywalking/client-config.md"},l=p(`<h3 id="常用设置" tabindex="-1">常用设置 <a class="header-anchor" href="#常用设置" aria-label="Permalink to &quot;常用设置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 设置Agent命名空间，它用来隔离追踪和监控数据，当两个应用使用不同的名称空间时，跨进程传播链会中断。</span></span>
