import{_ as s,c as n,o as a,a as l}from"./app.a840672a.js";const y=JSON.parse('{"title":"prometheus","description":"","frontmatter":{"title":"prometheus"},"headers":[{"level":2,"title":"简介","slug":"简介","link":"#简介","children":[]},{"level":2,"title":"配置","slug":"配置","link":"#配置","children":[{"level":3,"title":"通用","slug":"通用","link":"#通用","children":[{"level":4,"title":"抓取配置<scrape_config>","slug":"抓取配置-scrape-config","link":"#抓取配置-scrape-config","children":[]}]},{"level":3,"title":"rules","slug":"rules","link":"#rules","children":[]},{"level":3,"title":"模板","slug":"模板","link":"#模板","children":[{"level":4,"title":"数据格式","slug":"数据格式","link":"#数据格式","children":[]},{"level":4,"title":"方法","slug":"方法","link":"#方法","children":[]}]},{"level":3,"title":"字符串","slug":"字符串","link":"#字符串","children":[{"level":4,"title":"迭代","slug":"迭代","link":"#迭代","children":[]},{"level":4,"title":"管道","slug":"管道","link":"#管道","children":[]}]}]}],"relativePath":"ops/prometheus/index.md","lastUpdated":1678341619000}'),t={name:"ops/prometheus/index.md"},e=l(`<h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-hidden="true">#</a></h2><blockquote><p><a href="https://prometheus.io/" target="_blank" rel="noreferrer">官网</a></p><p><a href="https://github.com/prometheus" target="_blank" rel="noreferrer">Prometheus (github.com)</a></p><p>基于时序数据库的开源监控告警系统</p></blockquote><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-hidden="true">#</a></h2><blockquote><p>官方配置文档 <a href="https://prometheus.io/docs/prometheus/latest/configuration/configuration/" target="_blank" rel="noreferrer">Configuration | Prometheus</a></p><p>下面记录一下经常修改的配置文件</p></blockquote><h3 id="通用" tabindex="-1">通用 <a class="header-anchor" href="#通用" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">global:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  [ - &lt;remote_read&gt; ... ]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="抓取配置-scrape-config" tabindex="-1">抓取配置<code>&lt;scrape_config&gt;</code> <a class="header-anchor" href="#抓取配置-scrape-config" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 作业名称.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  [ - &lt;http_sd_config&gt; ... ]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="rules" tabindex="-1">rules <a class="header-anchor" href="#rules" aria-hidden="true">#</a></h3><blockquote><p>记录规则,可以预先计算经常需要或计算量大的表达式，并将其结果保存为一组新的时间序列</p><p>警报规则允许您基于 Prometheus 表达式语言表达式定义警报条件，并向外部服务发送有关发射警报的通知。每当警报表达式在给定时间点产生一个或多个向量元素时，警报对这些元素的标签集计为活动的。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">groups: #  分组</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        description: &quot;{{ $labels.instance }}请求延迟的中位数大于1秒(当前值 {{ $value }}s)&quot;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="模板" tabindex="-1">模板 <a class="header-anchor" href="#模板" aria-hidden="true">#</a></h3><blockquote><p>Prometheus 模板语言是基于 Go 模板系统的</p></blockquote><h4 id="数据格式" tabindex="-1">数据格式 <a class="header-anchor" href="#数据格式" aria-hidden="true">#</a></h4><blockquote><p>样本的度量名称保存在Labels中的<code>__name__</code>中</p><p>名称都以<code>_</code>进行分割</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">type sample struct {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="管道" tabindex="-1">管道 <a class="header-anchor" href="#管道" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 查询第一个值并格式化</span></span>
...
<span class="line"><span style="color:#A6ACCD;">{{ end }}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,27),p=[e];function o(r,i,c,d,C,A){return a(),n("div",null,p)}const h=s(t,[["render",o]]);export{y as __pageData,h as default};
