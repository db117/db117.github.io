import{_ as s,o as n,c as e,ah as t}from"./chunks/framework.BM5zFche.js";const h=JSON.parse('{"title":"Docker","description":"","frontmatter":{"title":"Docker"},"headers":[],"relativePath":"infrastructure/ops/containers/docker/index.md","filePath":"infrastructure/ops/containers/docker/index.md","lastUpdated":1784602594000}'),p={name:"infrastructure/ops/containers/docker/index.md"};function l(i,a,r,o,c,d){return n(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="docker" tabindex="-1">Docker <a class="header-anchor" href="#docker" aria-label="Permalink to &quot;Docker&quot;">​</a></h1><blockquote><p><a href="https://www.docker.com/" target="_blank" rel="noreferrer">Docker: Accelerated, Containerized Application Development</a></p></blockquote><h2 id="文档" tabindex="-1">文档 <a class="header-anchor" href="#文档" aria-label="Permalink to &quot;文档&quot;">​</a></h2><ul><li><a href="./commands.html">常用命令</a>：容器、镜像、网络和文件复制命令速查。</li><li><a href="./install/">安装</a>：Ubuntu、RPM 离线、阿里云镜像源和远程连接。</li><li><a href="./easyconnect.html">EasyConnect 透明代理</a>：在 Docker 中运行 EasyConnect。</li><li><a href="./zabbix.html">Zabbix</a>：Docker 搭建 Zabbix。</li></ul><h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><p>常规操作</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 进入容器</span></span>
...
</code></pre><p><a href="https://docker.mirrors.ustc.edu.cn" target="_blank" rel="noreferrer">https://docker.mirrors.ustc.edu.cn</a></p></li></ul>`,24)])])}const m=s(p,[["render",l]]);export{h as __pageData,m as default};
