import{_ as n,c as a,o as p,ah as e}from"./chunks/framework.HOMaeY8S.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"ops/nginx/nginx-https.md","filePath":"ops/nginx/nginx-https.md"}'),l={name:"ops/nginx/nginx-https.md"};function t(i,s,c,o,r,_){return p(),a("div",null,s[0]||(s[0]=[e(`<h4 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#user  nobody;</span></span>
