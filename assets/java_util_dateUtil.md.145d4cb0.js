...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>复杂格式实现</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 时间格式非常规</span></span>
...
<span class="line"><span style="color:#A6ACCD;">            .toFormatter();</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,7),o=[p];function t(r,c,i,A,C,y){return n(),a("div",null,o)}const D=s(l,[["render",t]]);export{d as __pageData,D as default};
