import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"Nginx HTTPS","description":"","frontmatter":{"title":"Nginx HTTPS"},"headers":[],"relativePath":"infrastructure/ops/gateway/nginx/https.md","filePath":"infrastructure/ops/gateway/nginx/https.md","lastUpdated":1786950773000}`),a={name:`infrastructure/ops/gateway/nginx/https.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<h1 id="nginx-https" tabindex="-1">Nginx HTTPS <a class="header-anchor" href="#nginx-https" aria-label="Permalink to “Nginx HTTPS”">​</a></h1><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to “配置文件”">​</a></h2><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>#user  nobody;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="http-转-https" tabindex="-1">http 转 https <a class="header-anchor" href="#http-转-https" aria-label="Permalink to “http 转 https”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 80强转443 HTTPS</span></span>
<span class="line"><span>	server {</span></span>
<span class="line"><span>		listen 80;</span></span>
<span class="line"><span>		server_name *.db117.top;</span></span>
<span class="line"><span>		return 301 https://$http_host$request_uri;</span></span>
