...
<span class="line"><span style="color:#A6ACCD;">    .annotateField(new RuntimeDefinitionImpl())		// 给字段添加注解</span></span></code></pre></div>`,28),o=[t];function p(c,i,r,d,C,A){return n(),a("div",null,o)}const h=s(l,[["render",p]]);export{y as __pageData,h as default};
