import{_ as s,o as a,c as n,S as l}from"./chunks/framework.1603d207.js";const d=JSON.parse('{"title":"Freemarker","description":"","frontmatter":{"title":"Freemarker"},"headers":[],"relativePath":"util/Freemarker.md","filePath":"util/Freemarker.md","lastUpdated":1692600405000}'),p={name:"util/Freemarker.md"},e=l(`<h2 id="基础语法" tabindex="-1">基础语法 <a class="header-anchor" href="#基础语法" aria-label="Permalink to &quot;基础语法&quot;">​</a></h2><h3 id="字符输出" tabindex="-1">字符输出 <a class="header-anchor" href="#字符输出" aria-label="Permalink to &quot;字符输出&quot;">​</a></h3><ul><li><p>变量存在，输出该变量，否则不输出 <code>\${emp.name?if_exists} </code></p></li><li><p>变量存在，输出该变量，否则不输出</p><pre><code>\${emp.name!}
</code></pre></li><li><p>变量不存在，取默认值xxx</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${emp.name?default(&quot;xxx&quot;)}</span></span></code></pre></div></li><li><p>变量不存在，取默认值xxx</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${emp.name!&quot;xxx&quot;}</span></span></code></pre></div></li><li><p>对字符串进行HTML编码，对html中特殊字符进行转义</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;123&lt;br&gt;456&quot;?html}</span></span></code></pre></div></li><li><p>使字符串第一个字母大写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;str&quot;?cap_first}</span></span></code></pre></div></li><li><p>将字符串转换成小写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;Str&quot;?lower_case}</span></span></code></pre></div></li><li><p>将字符串转换成大写</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;Str&quot;?upper_case}</span></span></code></pre></div></li><li><p>去掉字符串前后的空白字符</p><ul><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;str&quot;?trim}</span></span></code></pre></div></li></ul></li><li><p>输出hello+变量名</p><ul><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;hello\${emp.name!}&quot;}</span></span></code></pre></div></li><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${&quot;hello&quot;+emp.name!}</span></span></code></pre></div></li></ul></li><li><p>截取子串</p><ul><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;#assign str = &quot;abcdefghijklmn&quot;/&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  \${str[1..4]} 　　　 // 结果是bcde// 返回指定字符的索引\${str?index_of(&quot;n&quot;)}</span></span></code></pre></div></li></ul></li></ul><h3 id="日期输出" tabindex="-1">日期输出 <a class="header-anchor" href="#日期输出" aria-label="Permalink to &quot;日期输出&quot;">​</a></h3><ul><li><p>日期格式</p><ul><li><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${emp.date?string(&#39;yyyy-MM-dd&#39;)}</span></span></code></pre></div></li></ul></li></ul><h3 id="数字输出" tabindex="-1">数字输出 <a class="header-anchor" href="#数字输出" aria-label="Permalink to &quot;数字输出&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\${num?c}</span></span>
...
<span class="line"><span style="color:#A6ACCD;">#{x; m1M2} // 输出4.0</span></span></code></pre></div><h3 id="比较运算符" tabindex="-1">比较运算符 <a class="header-anchor" href="#比较运算符" aria-label="Permalink to &quot;比较运算符&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">= 或 == ：判断两个值是否相等.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">&lt;= 或 lte ：判断左边值是否小于等于右边值</span></span></code></pre></div><h3 id="逻辑判断" tabindex="-1">逻辑判断 <a class="header-anchor" href="#逻辑判断" aria-label="Permalink to &quot;逻辑判断&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;#if condition&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">...</span></span>
...
<span class="line"><span style="color:#A6ACCD;">...</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;/#if&gt;</span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">条件可为数字，可为字符串</span></span>
...
<span class="line"><span style="color:#A6ACCD;"> ....</span></span>
<span class="line"><span style="color:#A6ACCD;"> &lt;/#switch&gt;</span></span></code></pre></div><h3 id="空值判断" tabindex="-1">空值判断 <a class="header-anchor" href="#空值判断" aria-label="Permalink to &quot;空值判断&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 当 object 不为空时</span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;#if object??&gt;...&lt;/#if&gt;</span></span></code></pre></div><h3 id="集合-循环" tabindex="-1">集合 &amp; 循环 <a class="header-anchor" href="#集合-循环" aria-label="Permalink to &quot;集合 &amp; 循环&quot;">​</a></h3><h4 id="遍历集合" tabindex="-1">遍历集合 <a class="header-anchor" href="#遍历集合" aria-label="Permalink to &quot;遍历集合&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">&lt;#list empList! as emp&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">emp[&quot;name&quot;]    // 使用方括号</span></span></code></pre></div><h3 id="转义字符" tabindex="-1">转义字符 <a class="header-anchor" href="#转义字符" aria-label="Permalink to &quot;转义字符&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">\\&quot; ：双引号(u0022)</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">&lt;#nt&gt;// 取消上面的效果</span></span></code></pre></div>`,32),t=[e];function o(c,i,r,C,A,u){return a(),n("div",null,t)}const D=s(p,[["render",o]]);export{d as __pageData,D as default};
