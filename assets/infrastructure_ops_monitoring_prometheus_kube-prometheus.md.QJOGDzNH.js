import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"kube-prometheus","description":"","frontmatter":{"title":"kube-prometheus"},"headers":[],"relativePath":"infrastructure/ops/monitoring/prometheus/kube-prometheus.md","filePath":"infrastructure/ops/monitoring/prometheus/kube-prometheus.md","lastUpdated":1787128181000}`),a={name:`infrastructure/ops/monitoring/prometheus/kube-prometheus.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<blockquote><p><a href="https://github.com/prometheus-operator/kube-prometheus" target="_blank" rel="noreferrer">kube-prometheus</a></p><p>该项目使用<code>jsonnet</code>编写，上手有一定难度。</p><p>主要是在 k8s 中部署监控的一系列工具。</p><ul><li><a href="https://github.com/prometheus-operator/prometheus-operator" target="_blank" rel="noreferrer">Prometheus Operator</a></li><li>高可用 <a href="https://prometheus.io/" target="_blank" rel="noreferrer">Prometheus</a></li><li>高可用 <a href="https://github.com/prometheus/alertmanager" target="_blank" rel="noreferrer">Alertmanager</a></li><li><a href="https://github.com/prometheus/node_exporter" target="_blank" rel="noreferrer">Prometheus node-exporter</a></li><li><a href="https://github.com/DirectXMan12/k8s-prometheus-adapter" target="_blank" rel="noreferrer">Prometheus Adapter for Kubernetes Metrics APIs</a></li><li><a href="https://github.com/kubernetes/kube-state-metrics" target="_blank" rel="noreferrer">kube-state-metrics</a></li><li><a href="https://grafana.com/" target="_blank" rel="noreferrer">Grafana</a></li></ul></blockquote><h2 id="简单使用" tabindex="-1">简单使用 <a class="header-anchor" href="#简单使用" aria-label="Permalink to “简单使用”">​</a></h2><blockquote><p>对默认的没有特别的要求情况下可以直接使用</p></blockquote><h3 id="前置条件" tabindex="-1">前置条件 <a class="header-anchor" href="#前置条件" aria-label="Permalink to “前置条件”">​</a></h3><ul><li>go环境</li><li>安装jb(jsonnet-bundler) <ul><li>使用go安装<div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>go get github.com/jsonnet-bundler/jsonnet-bundler/cmd/jb</span></span></code></pre></div></li><li>使用brewhome安装<div class="language-shell"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> brew</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> jsonnet-bundler</span></span></code></pre></div></li></ul></li><li>gojsontoyaml安装<div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>go get github.com/brancz/gojsontoyaml</span></span></code></pre></div></li></ul><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to “使用”">​</a></h3><ul><li><p>修改配置文件</p><blockquote><p>example.jsonnet</p></blockquote></li><li><p>生成文件</p><blockquote><p>运行<code>./build.sh example.jsonnet</code> 会在<code>manifests</code>目录生成配置文件</p></blockquote></li><li><p>格式化.jsonnet</p><blockquote><p>需要安装jsonnetfmt</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>  git clone git@github.com:google/go-jsonnet.git</span></span>
<span class="line"><span>  cd go-jsonnet</span></span>
<span class="line"><span>  go build ./cmd/jsonnetfmt</span></span></code></pre></div><blockquote><p>使用vsCode的<code>jsonnet Formatter</code>插件 或者使用下面代码直接格式化</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span> jsonnetfmt --indent 2 --max-blank-lines 2 --sort-imports --string-style s --comment-style s -i test.jsonnet</span></span></code></pre></div></li></ul><h3 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-label="Permalink to “注意事项”">​</a></h3><ul><li>vendor目录是jb生成的</li><li>除配置文件都是从github上面copy的不需要修改直接<code>jb update</code></li></ul><h2 id="自定义配置" tabindex="-1">自定义配置 <a class="header-anchor" href="#自定义配置" aria-label="Permalink to “自定义配置”">​</a></h2><blockquote><p>默认的配置,不满足的情况下。</p><p>实际上都是对生成的文件进行修改，如果不想写配置文件，可以直接对生成的文件进行修改使用。</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>local filter = {</span></span>
...
<span class="line"><span>{ [&#39;prometheus-adapter-&#39; + name]: kp.prometheusAdapter[name] for name in std.objectFields(kp.prometheusAdapter) }</span></span></code></pre></div>`,12)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};