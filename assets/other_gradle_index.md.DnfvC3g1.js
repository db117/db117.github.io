import{it as e,rt as t,s as n,vt as r}from"./chunks/framework.DmYqD9Nl.js";var i=JSON.parse(`{"title":"gradle","description":"","frontmatter":{"title":"gradle"},"headers":[],"relativePath":"other/gradle/index.md","filePath":"other/gradle/index.md","lastUpdated":1785488300000}`),a={name:`other/gradle/index.md`};function o(n,i,a,o,s,c){return r(),t(`div`,null,[...i[0]||=[e(`<h2 id="gradle" tabindex="-1">gradle <a class="header-anchor" href="#gradle" aria-label="Permalink to “gradle”">​</a></h2><h2 id="gradle配置国内镜像" tabindex="-1">gradle配置国内镜像 <a class="header-anchor" href="#gradle配置国内镜像" aria-label="Permalink to “gradle配置国内镜像”">​</a></h2><blockquote><p>对于 gradle 的配置文件。</p><p>gradle-wrapper.properties</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>distributionUrl=https\\://mirrors.cloud.tencent.com/gradle/gradle-8.8-bin.zip</span></span></code></pre></div><p>对所有项目生效，在\${USER_HOME}/.gradle/下创建init.gradle文件</p><p><a href="https://docs.gradle.org/current/userguide/init_scripts.html#sec:using_an_init_script" target="_blank" rel="noreferrer">https://docs.gradle.org/current/userguide/init_scripts.html#sec:using_an_init_script</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>allprojects{</span></span>
