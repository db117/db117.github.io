...
<span class="line"><span>          match: after                                # 合并到上一行的末尾, 为了error等日志</span></span>
<span class="line"><span>          max_lines: 1000                             # 最大的行数</span></span>
<span class="line"><span>          timeout: 30s                                # 如果在规定的时候没有新的日志事件就不等待后面的日志</span></span></code></pre></div>`,12),l=[p];function i(o,c,r,d,h,u){return s(),n("div",null,l)}const _=a(t,[["render",i]]);export{g as __pageData,_ as default};
