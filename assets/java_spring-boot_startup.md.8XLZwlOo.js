import{et as e,it as t,rt as n,s as r,vt as i}from"./chunks/framework.DmYqD9Nl.js";var a=JSON.parse(`{"title":"spring-boot启动流程","description":"","frontmatter":{"title":"spring-boot启动流程"},"headers":[],"relativePath":"java/spring-boot/startup.md","filePath":"java/spring-boot/startup.md","lastUpdated":1785467468000}`),o={name:`java/spring-boot/startup.md`};function s(r,a,o,s,c,l){return i(),n(`div`,null,[...a[0]||=[e(`iframe`,{id:`embed_dom`,name:`embed_dom`,frameborder:`0`,style:{display:`block`,width:`725px`,height:`245px`},src:`https://www.processon.com/embed/60f69a560e3e74596bab3b71`},null,-1),t(`<h3 id="执行启动类的mian" tabindex="-1">执行启动类的mian <a class="header-anchor" href="#执行启动类的mian" aria-label="Permalink to “执行启动类的mian”">​</a></h3><blockquote><p>解压后的目录结构</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>├── BOOT-INF</span></span>
...
<span class="line"><span>  java.lang.ClassLoader#loadClass(java.lang.String, boolean)</span></span></code></pre></div><h3 id="启动类main" tabindex="-1">启动类main <a class="header-anchor" href="#启动类main" aria-label="Permalink to “启动类main”">​</a></h3><blockquote><p>主要启动流程都在启动类main中。</p></blockquote>`,10),e(`iframe`,{id:`embed_dom`,name:`embed_dom`,frameborder:`0`,style:{display:`block`,width:`725px`,height:`245px`},src:`https://www.processon.com/embed/6602795e878a3f700d429747`},null,-1),t(`<p><strong>run</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>public ConfigurableApplicationContext run(String... args) {</span></span>
