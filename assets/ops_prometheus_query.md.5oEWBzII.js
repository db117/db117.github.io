import{_ as a,o as s,c as n,R as e}from"./chunks/framework.ANQB9ulZ.js";const v=JSON.parse('{"title":"查询语法","description":"","frontmatter":{"title":"查询语法"},"headers":[],"relativePath":"ops/prometheus/query.md","filePath":"ops/prometheus/query.md","lastUpdated":1703843411000}'),t={name:"ops/prometheus/query.md"},p=e(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h4 id="标签筛选" tabindex="-1">标签筛选 <a class="header-anchor" href="#标签筛选" aria-label="Permalink to &quot;标签筛选&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 正则匹配 lable</span></span>
