...
<span class="line"><span>public static &lt;U&gt; CompletableFuture&lt;U&gt; supplyAsync(Supplier&lt;U&gt; supplier, Executor executor)</span></span></code></pre></div><h3 id="获取结果" tabindex="-1">获取结果 <a class="header-anchor" href="#获取结果" aria-label="Permalink to “获取结果”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>// get 方法需要用户处理异常</span></span>
<span class="line"><span>get(long timeout, TimeUnit unit)</span></span>
<span class="line"><span>get()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>join()</span></span></code></pre></div><h3 id="结果处理" tabindex="-1">结果处理 <a class="header-anchor" href="#结果处理" aria-label="Permalink to “结果处理”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>// 任务结束了进行处理</span></span>
...
<span class="line"><span>public CompletableFuture&lt;T&gt; exceptionallyComposeAsync(Function&lt;Throwable, ? extends CompletionStage&lt;T&gt;&gt; fn,Executor executor)</span></span></code></pre></div><h2 id="使用场景" tabindex="-1">使用场景 <a class="header-anchor" href="#使用场景" aria-label="Permalink to “使用场景”">​</a></h2><h3 id="异步任务" tabindex="-1">异步任务 <a class="header-anchor" href="#异步任务" aria-label="Permalink to “异步任务”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>CompletableFuture&lt;String&gt; future = CompletableFuture.supplyAsync(() -&gt; {</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span></span></span>
<span class="line"><span>String result = future.get(); // 阻塞等待任务完成并获取结果</span></span></code></pre></div><h3 id="并行任务的执行" tabindex="-1">并行任务的执行 <a class="header-anchor" href="#并行任务的执行" aria-label="Permalink to “并行任务的执行”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>CompletableFuture&lt;String&gt; request1 = CompletableFuture.supplyAsync(() -&gt; performNetworkRequest1());</span></span>
...
<span class="line"><span>});</span></span></code></pre></div><h3 id="异常处理和容错机制" tabindex="-1">异常处理和容错机制 <a class="header-anchor" href="#异常处理和容错机制" aria-label="Permalink to “异常处理和容错机制”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>CompletableFuture&lt;String&gt; future = CompletableFuture.supplyAsync(() -&gt; {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>});</span></span></code></pre></div><h3 id="替代-java-util-concurrent-countdownlatch-的功能" tabindex="-1">替代 <code>java.util.concurrent.CountDownLatch</code> 的功能 <a class="header-anchor" href="#替代-java-util-concurrent-countdownlatch-的功能" aria-label="Permalink to “替代 java.util.concurrent.CountDownLatch 的功能”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>import java.util.concurrent.CompletableFuture;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,31)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};