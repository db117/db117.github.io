import{_ as s,o as e,c as a,R as n}from"./chunks/framework.H_1uJR_t.js";const b=JSON.parse('{"title":"sql 语句执行顺序","description":"","frontmatter":{"title":"sql 语句执行顺序"},"headers":[],"relativePath":"database/sql-exec-seq.md","filePath":"database/sql-exec-seq.md","lastUpdated":1699241780000}'),p={name:"database/sql-exec-seq.md"},l=n(`<blockquote><p>常用的 sql 中大致执行顺序</p><p>每一步都生成一个虚拟的表，供后面的表使用。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>(8) SELECT (9)DISTINCT&lt;Select_list&gt;</span></span>
