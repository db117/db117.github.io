import{_ as n,c as s,o as a,a5 as p}from"./chunks/framework.B-Ov6ZuM.js";const u=JSON.parse('{"title":"二分算法","description":"","frontmatter":{"title":"二分算法"},"headers":[],"relativePath":"other/algorithm/binarySearch.md","filePath":"other/algorithm/binarySearch.md","lastUpdated":1722243070000}'),l={name:"other/algorithm/binarySearch.md"},e=p(`<h3 id="精确查找" tabindex="-1">精确查找 <a class="header-anchor" href="#精确查找" aria-label="Permalink to &quot;精确查找&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
