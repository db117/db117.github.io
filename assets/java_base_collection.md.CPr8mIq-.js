...
<span class="line"><span>    implements List&lt;E&gt;, Deque&lt;E&gt;, Cloneable, java.io.Serializable</span></span></code></pre></div><blockquote><p><code>java.util.LinkedList</code></p><p>相比ArrayList多实现了java.util.Deque接口</p><p>使用双向链表来保存数据</p></blockquote><ul><li>不要通过index进行操作，会遍历链表</li></ul><h3 id="vector-线程安全" tabindex="-1">Vector(线程安全) <a class="header-anchor" href="#vector-线程安全" aria-label="Permalink to &quot;Vector(线程安全)&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public class Vector&lt;E&gt;</span></span>
...
<span class="line"><span>    implements java.io.Serializable, Cloneable</span></span></code></pre></div><ul><li>保存数据的数组大小为枚举的数量</li><li>操作数组使用<code>java.lang.Enum#ordinal</code>当index</li></ul><h3 id="concurrenthashmap-线程安全" tabindex="-1">ConcurrentHashMap(线程安全) <a class="header-anchor" href="#concurrenthashmap-线程安全" aria-label="Permalink to &quot;ConcurrentHashMap(线程安全)&quot;">​</a></h3><blockquote><p>最常用的线程安全map，主要结构跟 <code>hashmap</code>差不多。</p><p>synchronized 只锁定当前链表或红⿊⼆叉树的⾸节点，这样只要 hash 不冲突，就不会产⽣并发，效率⼜提升 N 倍。</p></blockquote><h5 id="concurrenthashmap流程图" tabindex="-1">ConcurrentHashMap流程图 <a class="header-anchor" href="#concurrenthashmap流程图" aria-label="Permalink to &quot;ConcurrentHashMap流程图&quot;">​</a></h5>`,47),c=a("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/61b6ee4a1efad42237b9a3ac"},null,-1),o=s(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public class ConcurrentHashMap&lt;K,V&gt; extends AbstractMap&lt;K,V&gt;</span></span>
...
<span class="line"><span>    implements java.io.Serializable {</span></span></code></pre></div><ul><li>使用最小堆实现</li><li>插入数据不能为null，即不能排序</li><li>扩容的时候如果容量小于 64 ，则翻倍。否则增加 50%</li></ul><h3 id="synchronousqueue-线程安全" tabindex="-1">SynchronousQueue（线程安全） <a class="header-anchor" href="#synchronousqueue-线程安全" aria-label="Permalink to &quot;SynchronousQueue（线程安全）&quot;">​</a></h3><blockquote><p>其内部是没有容器的，所以生产者生产一个数据，就堵塞了，必须等消费者消费后，生产者才能再次生产。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public class SynchronousQueue&lt;E&gt; extends AbstractQueue&lt;E&gt;</span></span>
