import{_ as s,o as a,c as p,ah as e}from"./chunks/framework.BM5zFche.js";const E=JSON.parse('{"title":"客户端配置","description":"","frontmatter":{"title":"客户端配置"},"headers":[],"relativePath":"ops/tracing/skywalking/client-config.md","filePath":"ops/tracing/skywalking/client-config.md","lastUpdated":1783680024000}'),l={name:"ops/tracing/skywalking/client-config.md"};function i(c,n,t,_,g,o){return a(),p("div",null,[...n[0]||(n[0]=[e(`<h3 id="常用设置" tabindex="-1">常用设置 <a class="header-anchor" href="#常用设置" aria-label="Permalink to &quot;常用设置&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 设置Agent命名空间，它用来隔离追踪和监控数据，当两个应用使用不同的名称空间时，跨进程传播链会中断。</span></span>
...
<span class="line"><span># plugin.mysql.trace_sql_parameters=\${SW_MYSQL_TRACE_SQL_PARAMETERS:false}</span></span></code></pre></div>`,2)])])}const d=s(l,[["render",i]]);export{E as __pageData,d as default};
