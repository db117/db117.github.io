...
<span class="line"><span>{ [&#39;prometheus-adapter-&#39; + name]: kp.prometheusAdapter[name] for name in std.objectFields(kp.prometheusAdapter) }</span></span></code></pre></div>`,12),t=[l];function o(i,r,c,u,m,h){return n(),a("div",null,t)}const k=s(p,[["render",o]]);export{b as __pageData,k as default};
