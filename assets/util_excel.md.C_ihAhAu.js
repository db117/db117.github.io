import{_ as a,c as s,o as n,a5 as e}from"./chunks/framework.gVONBIN7.js";const q=JSON.parse('{"title":"Excel 公式","description":"","frontmatter":{"title":"Excel 公式"},"headers":[],"relativePath":"util/excel.md","filePath":"util/excel.md"}'),p={name:"util/excel.md"},l=e(`<h3 id="文本" tabindex="-1">文本 <a class="header-anchor" href="#文本" aria-label="Permalink to &quot;文本&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 字符串拼接</span></span>
