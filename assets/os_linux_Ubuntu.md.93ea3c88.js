import{_ as a,c as e,e as n,a as l,o as r,r as o}from"./app.a840672a.js";const _=JSON.parse('{"title":"Ubuntu相关","description":"","frontmatter":{"title":"Ubuntu相关"},"headers":[{"level":4,"title":"安装Chrome","slug":"安装chrome","link":"#安装chrome","children":[]},{"level":4,"title":"安装chromedriver","slug":"安装chromedriver","link":"#安装chromedriver","children":[]}],"relativePath":"os/linux/Ubuntu.md","lastUpdated":1678341619000}'),p={name:"os/linux/Ubuntu.md"},t=l(`<h4 id="安装chrome" tabindex="-1">安装Chrome <a class="header-anchor" href="#安装chrome" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 安装依赖</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,7);function c(i,d,h,C,m,u){const s=o("TOC");return r(),e("div",null,[n(s),t])}const g=a(p,[["render",c]]);export{_ as __pageData,g as default};
