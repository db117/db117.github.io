import{_ as s,c as e,o as a,a as n}from"./app.5745f82f.js";const h=JSON.parse('{"title":"权限相关","description":"","frontmatter":{"title":"权限相关"},"headers":[{"level":2,"title":"备忘单","slug":"备忘单","link":"#备忘单","children":[{"level":3,"title":"授予权限","slug":"授予权限","link":"#授予权限","children":[]},{"level":3,"title":"回收权限","slug":"回收权限","link":"#回收权限","children":[]}]}],"relativePath":"database/sqlserver/permission.md","lastUpdated":1677837613000}'),l={name:"database/sqlserver/permission.md"},t=n(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-hidden="true">#</a></h2><h3 id="授予权限" tabindex="-1">授予权限 <a class="header-anchor" href="#授予权限" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">-- 把Student表查询权限授予userName</span></span>
