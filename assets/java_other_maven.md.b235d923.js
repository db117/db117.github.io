import{_ as s,o as a,c as n,U as t}from"./chunks/framework.190aac23.js";const m=JSON.parse('{"title":"maven","description":"","frontmatter":{"title":"maven"},"headers":[],"relativePath":"java/other/maven.md","filePath":"java/other/maven.md","lastUpdated":1689063504000}'),l={name:"java/other/maven.md"},e=t(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">#	打包跳过编译失败</span></span>
