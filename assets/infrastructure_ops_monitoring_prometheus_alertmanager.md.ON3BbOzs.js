import{et as e,it as t,rt as n,s as r,vt as i}from"./chunks/framework.DmYqD9Nl.js";var a=JSON.parse(`{"title":"alertmanager","description":"","frontmatter":{"title":"alertmanager"},"headers":[],"relativePath":"infrastructure/ops/monitoring/prometheus/alertmanager.md","filePath":"infrastructure/ops/monitoring/prometheus/alertmanager.md","lastUpdated":1785468151000}`),o={name:`infrastructure/ops/monitoring/prometheus/alertmanager.md`};function s(r,a,o,s,c,l){return i(),n(`div`,null,[...a[0]||=[e(`blockquote`,null,[e(`p`,null,`Prometheus 中的报警发送给 alertmanager . 在通过分组,过滤,抑制后发送给不同的通知接收器的列表`)],-1),e(`iframe`,{id:`embed_dom`,name:`embed_dom`,frameborder:`0`,style:{display:`block`,width:`725px`,height:`245px`},src:`https://www.processon.com/embed/60e579a51e08530a5074c834`},null,-1),t(`<h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to “配置”">​</a></h2><h3 id="通用配置" tabindex="-1">通用配置 <a class="header-anchor" href="#通用配置" aria-label="Permalink to “通用配置”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>global:</span></span>
...
<span class="line"><span>  [ - &lt;mute_time_interval&gt; ... ]</span></span></code></pre></div><h3 id="路由配置" tabindex="-1">路由配置 <a class="header-anchor" href="#路由配置" aria-label="Permalink to “路由配置”">​</a></h3><blockquote><p>可以嵌套</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 接收器</span></span>
...
<span class="line"><span>  [ - &lt;route&gt; ... ]</span></span></code></pre></div><h3 id="接收者配置" tabindex="-1">接收者配置 <a class="header-anchor" href="#接收者配置" aria-label="Permalink to “接收者配置”">​</a></h3><blockquote><p>消息接收方</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 接收者名称,会在路由中使用</span></span>
...
<span class="line"><span>  [ - &lt;wechat_config&gt;, ... ]</span></span></code></pre></div><h4 id="email接收" tabindex="-1">email接收 <a class="header-anchor" href="#email接收" aria-label="Permalink to “email接收”">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>#  是否通知已解决的警报</span></span>
...
<span class="line"><span>[ headers: { &lt;string&gt;: &lt;tmpl_string&gt;, ... } ]</span></span></code></pre></div><h4 id="企业微信通知" tabindex="-1">企业微信通知 <a class="header-anchor" href="#企业微信通知" aria-label="Permalink to “企业微信通知”">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>#  是否通知已解决的警报</span></span>
<span class="line"><span>[ send_resolved: &lt;boolean&gt; | default = false ]</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>[ to_tag: &lt;string&gt; | default = &#39;{{ template &quot;wechat.default.to_tag&quot; . }}&#39; ]</span></span></code></pre></div><h4 id="http回调" tabindex="-1">http回调 <a class="header-anchor" href="#http回调" aria-label="Permalink to “http回调”">​</a></h4><blockquote><p>向指定的 url 发送 POST HTTP请求</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>#  是否通知已解决的警报</span></span>
...
<span class="line"><span>[ max_alerts: &lt;int&gt; | default = 0 ]</span></span></code></pre></div><p>实例消息</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>{</span></span>
