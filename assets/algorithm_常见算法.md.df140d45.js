import{_ as s,c as n,o as a,a as l}from"./app.fc437e13.js";const d=JSON.parse('{"title":"常见算法","description":"","frontmatter":{"title":"常见算法"},"headers":[{"level":3,"title":"蓄水池抽样算法（Reservoir Sampling）","slug":"蓄水池抽样算法-reservoir-sampling","link":"#蓄水池抽样算法-reservoir-sampling","children":[]},{"level":3,"title":"最大公约数，最小公倍数","slug":"最大公约数-最小公倍数","link":"#最大公约数-最小公倍数","children":[]},{"level":3,"title":"枚举二进制子集","slug":"枚举二进制子集","link":"#枚举二进制子集","children":[]},{"level":3,"title":"最长上升子序列（Longest Increasing Subsequence）","slug":"最长上升子序列-longest-increasing-subsequence","link":"#最长上升子序列-longest-increasing-subsequence","children":[]}],"relativePath":"algorithm/常见算法.md","lastUpdated":1677491985000}'),p={name:"algorithm/常见算法.md"},e=l(`<h3 id="蓄水池抽样算法-reservoir-sampling" tabindex="-1">蓄水池抽样算法（Reservoir Sampling） <a class="header-anchor" href="#蓄水池抽样算法-reservoir-sampling" aria-hidden="true">#</a></h3><blockquote><p><strong>给定一个数据流，数据流长度N很大，且N直到处理完所有数据之前都不可知，请问如何在只遍历一遍数据（O(N)）的情况下，能够随机选取出K个不重复的数据。</strong></p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">int[] result = new int[K];</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="最大公约数-最小公倍数" tabindex="-1">最大公约数，最小公倍数 <a class="header-anchor" href="#最大公约数-最小公倍数" aria-hidden="true">#</a></h3><blockquote><p>求最小公倍数需要最大公约数</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 最小公倍数</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="枚举二进制子集" tabindex="-1">枚举二进制子集 <a class="header-anchor" href="#枚举二进制子集" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// m =&gt; 总状态数</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="最长上升子序列-longest-increasing-subsequence" tabindex="-1">最长上升子序列（Longest Increasing Subsequence） <a class="header-anchor" href="#最长上升子序列-longest-increasing-subsequence" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 动态规划 O(n2)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,10),o=[e];function c(i,t,r,C,A,y){return a(),n("div",null,o)}const u=s(p,[["render",c]]);export{d as __pageData,u as default};
