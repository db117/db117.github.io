import{_ as n,c as s,o as a,a8 as p}from"./chunks/framework.n88ns4tz.js";const m=JSON.parse('{"title":"常见算法","description":"","frontmatter":{"title":"常见算法"},"headers":[],"relativePath":"algorithm/常见算法.md","filePath":"algorithm/常见算法.md","lastUpdated":1712285624000}'),l={name:"algorithm/常见算法.md"},e=p(`<h3 id="蓄水池抽样算法-reservoir-sampling" tabindex="-1">蓄水池抽样算法（Reservoir Sampling） <a class="header-anchor" href="#蓄水池抽样算法-reservoir-sampling" aria-label="Permalink to &quot;蓄水池抽样算法（Reservoir Sampling）&quot;">​</a></h3><blockquote><p><strong>给定一个数据流，数据流长度N很大，且N直到处理完所有数据之前都不可知，请问如何在只遍历一遍数据（O(N)）的情况下，能够随机选取出K个不重复的数据。</strong></p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>int[] result = new int[K];</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="最大公约数-最小公倍数" tabindex="-1">最大公约数，最小公倍数 <a class="header-anchor" href="#最大公约数-最小公倍数" aria-label="Permalink to &quot;最大公约数，最小公倍数&quot;">​</a></h3><blockquote><p>求最小公倍数需要最大公约数</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 最小公倍数</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="最长上升子序列-longest-increasing-subsequence" tabindex="-1">最长上升子序列（Longest Increasing Subsequence） <a class="header-anchor" href="#最长上升子序列-longest-increasing-subsequence" aria-label="Permalink to &quot;最长上升子序列（Longest Increasing Subsequence）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 动态规划 O(n2)</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div>`,10),i=[e];function t(c,o,r,d,u,h){return a(),s("div",null,i)}const b=n(l,[["render",t]]);export{m as __pageData,b as default};
