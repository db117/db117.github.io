import{_ as s,c as a,o as n,a as t}from"./app.3d2db0cb.js";const y=JSON.parse('{"title":"prometheus","description":"","frontmatter":{"title":"prometheus"},"headers":[{"level":2,"title":"简介","slug":"简介","link":"#简介","children":[]},{"level":2,"title":"配置","slug":"配置","link":"#配置","children":[{"level":3,"title":"通用","slug":"通用","link":"#通用","children":[]},{"level":3,"title":"rules","slug":"rules","link":"#rules","children":[]},{"level":3,"title":"模板","slug":"模板","link":"#模板","children":[]},{"level":3,"title":"字符串","slug":"字符串","link":"#字符串","children":[]}]}],"relativePath":"ops/prometheus/README.md","lastUpdated":1677230567000}'),l={name:"ops/prometheus/README.md"},e=t(`<h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-hidden="true">#</a></h2><blockquote><p><a href="https://prometheus.io/" target="_blank" rel="noreferrer">官网</a></p><p><a href="https://github.com/prometheus" target="_blank" rel="noreferrer">Prometheus (github.com)</a></p><p>基于时序数据库的开源监控告警系统</p></blockquote><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-hidden="true">#</a></h2><blockquote><p>官方配置文档 <a href="https://prometheus.io/docs/prometheus/latest/configuration/configuration/" target="_blank" rel="noreferrer">Configuration | Prometheus</a></p><p>下面记录一下经常修改的配置文件</p></blockquote><h3 id="通用" tabindex="-1">通用 <a class="header-anchor" href="#通用" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">global:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">{{ end }}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,27),p=[e];function o(r,i,c,d,C,A){return n(),a("div",null,p)}const h=s(l,[["render",o]]);export{y as __pageData,h as default};
