import{_ as e,o as p,c as l,j as s,ah as n}from"./chunks/framework.CZP_9SSd.js";const b=JSON.parse('{"title":"java集合","description":"","frontmatter":{"title":"java集合"},"headers":[],"relativePath":"java/base/collection.md","filePath":"java/base/collection.md","lastUpdated":1779086006000}'),t={name:"java/base/collection.md"};function i(c,a,o,r,d,u){return p(),l("div",null,[...a[0]||(a[0]=[s("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60e5834f6376892c1ec611af"},null,-1),n(`<h2 id="list" tabindex="-1">List <a class="header-anchor" href="#list" aria-label="Permalink to &quot;List&quot;">​</a></h2><h3 id="arraylist" tabindex="-1">ArrayList <a class="header-anchor" href="#arraylist" aria-label="Permalink to &quot;ArrayList&quot;">​</a></h3><blockquote><p><code>java.util.ArrayList</code></p><p>最常用的集合,实现方式为数组</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ArrayList&lt;E&gt; extends AbstractList&lt;E&gt;</span></span>
<span class="line"><span>        implements List&lt;E&gt;, RandomAccess, Cloneable, java.io.Serializable</span></span></code></pre></div><ul><li><p>使用<code>transient Object[] elementData;</code>来保存数据，默认大小为10</p></li><li><p>每一次扩容为之前的1.5倍<code>int newCapacity = oldCapacity + (oldCapacity &gt;&gt; 1);</code></p></li><li><p>标记为java.util.RandomAccess，可进行随机访问</p></li><li><p>删除元素需要调用 <code>System.arraycopy()</code> 将 index+1 后面的元素都复制到 index 位置上，该操作的时间复杂度为 O(N)</p></li><li><p>subList</p><blockquote><p>访问时通过从定向index来实现，添加修改会改变原来的List</p></blockquote></li><li><p><code>java.util.Arrays.ArrayList</code>为<code>Arrays</code>的实现，不能修改。但是可以get，set</p></li></ul><h3 id="linkedlist" tabindex="-1">LinkedList <a class="header-anchor" href="#linkedlist" aria-label="Permalink to &quot;LinkedList&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class LinkedList&lt;E&gt;</span></span>
