...
<span class="line"><span style="color:#A6ACCD;">kubectl create -f manifests/</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>全部删除</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">kubectl delete --ignore-not-found=true -f manifests/ -f manifests/setup</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>需要自己来添加 ingress 来访问service</p><ul><li>告警服务 <code>alertmanager-main:9093</code></li><li>prometheus <code>prometheus-k8s:9090</code></li><li>Grafana <code>grafana:3000</code></li></ul><p>默认是没有配置报警接收器，需要修改配置。详情见后面。</p><h2 id="普通使用" tabindex="-1">普通使用 <a class="header-anchor" href="#普通使用" aria-hidden="true">#</a></h2><blockquote><p>通过自定义的<code>k8s</code>组件对各种服务进行动态配置</p><p>可以通过简单的k8s自定义资源对整个监控系统进行配置</p></blockquote><ul><li><p>ServiceMonitor</p><blockquote><p>选择一部分 <code>service</code>来生成 <code>target</code>配置。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">apiVersion: monitoring.coreos.com/v1</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      prometheus: backend</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>PodMonitor</p><blockquote><p>选择一部分 <code>pod</code>来生成 <code>target</code>配置。</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">apiVersion: monitoring.coreos.com/v1</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>PrometheusRule</p><blockquote><p>添加 <code>Prometheus</code>的报警规则</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">apiVersion: monitoring.coreos.com/v1</span></span>
...
<span class="line"><span style="color:#A6ACCD;">          for: 10m  					# 持续时间，满足后才报警</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>AlertmanagerConfig</p><blockquote><p>修改通知规则，<code>Prometheus</code>生成报警后，发送到 <code>Alertmanager</code>。进行分组，抑制，通知。</p><p>简单使用，不建议使用。<code>kube-prometheus</code>中并没有添加支持。</p><p>如需修改可以直接修改 <code>alertmanager-main</code>Secret</p></blockquote></li></ul>`,15),p=[l];function o(c,r,i,C,A,d){return a(),n("div",null,p)}const h=s(t,[["render",o]]);export{m as __pageData,h as default};
