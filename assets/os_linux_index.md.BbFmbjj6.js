import{_ as n,c as a,o as p,ah as e}from"./chunks/framework.BjlmIy4T.js";const g=JSON.parse('{"title":"linux","description":"","frontmatter":{"title":"linux"},"headers":[],"relativePath":"os/linux/index.md","filePath":"os/linux/index.md"}'),l={name:"os/linux/index.md"};function t(i,s,c,o,d,r){return p(),a("div",null,s[0]||(s[0]=[e(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><h3 id="权限" tabindex="-1">权限 <a class="header-anchor" href="#权限" aria-label="Permalink to &quot;权限&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 将文件 file1.txt 设为所有人皆可读取</span></span>
