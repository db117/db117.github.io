import{_ as a,c as s,o as n,a7 as e}from"./chunks/framework.D38zyZX2.js";const m=JSON.parse('{"title":"服务配置","description":"","frontmatter":{"title":"服务配置"},"headers":[],"relativePath":"ops/skywalking/server-config.md","filePath":"ops/skywalking/server-config.md","lastUpdated":1716896352000}'),l={name:"ops/skywalking/server-config.md"},p=e(`<h3 id="常用配置" tabindex="-1">常用配置 <a class="header-anchor" href="#常用配置" aria-label="Permalink to &quot;常用配置&quot;">​</a></h3><h3 id="application-yml" tabindex="-1">application.yml <a class="header-anchor" href="#application-yml" aria-label="Permalink to &quot;application.yml&quot;">​</a></h3><blockquote><p>服务端核心配置类</p><p>这个设置文件背后的核心概念是，Skywalking的Collector基于纯模块化设计。 最终用户可以根据自己的需求切换或组装收集器功能。</p></blockquote><h4 id="核心配置" tabindex="-1">核心配置 <a class="header-anchor" href="#核心配置" aria-label="Permalink to &quot;核心配置&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>core:</span></span>
