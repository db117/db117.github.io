import{_ as a,o as n,c as e,ah as p}from"./chunks/framework.CZP_9SSd.js";const _=JSON.parse('{"title":"docker阿里云镜像安装","description":"","frontmatter":{"title":"docker阿里云镜像安装"},"headers":[],"relativePath":"ops/docker/软件安装/docker阿里云镜像安装.md","filePath":"ops/docker/软件安装/docker阿里云镜像安装.md","lastUpdated":1779086006000}'),c={name:"ops/docker/软件安装/docker阿里云镜像安装.md"};function l(t,s,o,i,r,d){return n(),e("div",null,[...s[0]||(s[0]=[p(`<ul><li>配置docker阿里云yum源 (直接执行下面的命令即可)</li></ul><div class="language-cat vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cat</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>   [docker-ce-edge]</span></span>
