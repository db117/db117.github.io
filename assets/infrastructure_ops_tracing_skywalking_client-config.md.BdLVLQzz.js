import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"客户端配置","description":"","frontmatter":{"title":"客户端配置"},"headers":[],"relativePath":"infrastructure/ops/tracing/skywalking/client-config.md","filePath":"infrastructure/ops/tracing/skywalking/client-config.md","lastUpdated":1786437432000}`),a={name:`infrastructure/ops/tracing/skywalking/client-config.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<h3 id="常用设置" tabindex="-1">常用设置 <a class="header-anchor" href="#常用设置" aria-label="Permalink to “常用设置”">​</a></h3><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 设置Agent命名空间，它用来隔离追踪和监控数据，当两个应用使用不同的名称空间时，跨进程传播链会中断。</span></span>
...
<span class="line"><span># agent.is_open_debugging_class\xA0=\xA0\${SW_AGENT_OPEN_DEBUG:true}</span></span>
<span class="line"><span> </span></span>
...
<span class="line"><span># plugin.mysql.trace_sql_parameters=\${SW_MYSQL_TRACE_SQL_PARAMETERS:false}</span></span></code></pre></div>`,2)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};