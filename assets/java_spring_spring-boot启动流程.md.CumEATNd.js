import{_ as s,c as e,o as p,m as n,a8 as a}from"./chunks/framework.BaglXmoE.js";const S=JSON.parse('{"title":"spring-boot启动流程","description":"","frontmatter":{"title":"spring-boot启动流程"},"headers":[],"relativePath":"java/spring/spring-boot启动流程.md","filePath":"java/spring/spring-boot启动流程.md","lastUpdated":1710641614000}'),t={name:"java/spring/spring-boot启动流程.md"},i=n("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60f69a560e3e74596bab3b71"},null,-1),o=a(`<h3 id="执行启动类的mian" tabindex="-1">执行启动类的mian <a class="header-anchor" href="#执行启动类的mian" aria-label="Permalink to &quot;执行启动类的mian&quot;">​</a></h3><blockquote><p>解压后的目录结构</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>├── BOOT-INF</span></span>
...
<span class="line"><span>    		org.springframework.boot.loader.MainMethodRunner#run</span></span></code></pre></div><ul><li><p>org.springframework.boot.loader.LaunchedURLClassLoader 类加载器</p><blockquote><p>通过spring-boot的自定义加载器来加载项目的代码以及依赖jar中的代码</p></blockquote></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>org.springframework.boot.loader.LaunchedURLClassLoader#loadClass</span></span>
...
<span class="line"><span>  java.lang.ClassLoader#loadClass(java.lang.String, boolean)</span></span></code></pre></div><h3 id="启动类main" tabindex="-1">启动类main <a class="header-anchor" href="#启动类main" aria-label="Permalink to &quot;启动类main&quot;">​</a></h3><blockquote><p>主要启动流程都在启动类main中。</p></blockquote>`,10),l=n("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60f6a44be401fd09d480564a"},null,-1),r=a(`<p><strong>run</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public ConfigurableApplicationContext run(String... args) {</span></span>
...
<span class="line"><span>	}</span></span></code></pre></div><p><strong>prepareEnvironment</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>private ConfigurableEnvironment prepareEnvironment(SpringApplicationRunListeners listeners,</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p><strong>prepareContext</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>private void prepareContext(ConfigurableApplicationContext context, ConfigurableEnvironment environment,</span></span>
