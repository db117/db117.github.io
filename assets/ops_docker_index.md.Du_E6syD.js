import{_ as a,c as s,o as n,a8 as e}from"./chunks/framework.n88ns4tz.js";const k=JSON.parse('{"title":"docker","description":"","frontmatter":{"title":"docker"},"headers":[],"relativePath":"ops/docker/index.md","filePath":"ops/docker/index.md","lastUpdated":1712285624000}'),t={name:"ops/docker/index.md"},p=e(`<blockquote><p><a href="https://www.docker.com/" target="_blank" rel="noreferrer">Docker: Accelerated, Containerized Application Development</a></p></blockquote><h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><p>常规操作</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 进入容器</span></span>
...
<span class="line"><span>docker inspect --format &#39;{{ .State.Pid }}&#39;  4ddf4638572d</span></span></code></pre></div><p>删除容器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 批量删除镜像或容器</span></span>
...
<span class="line"><span>docker system prune</span></span></code></pre></div><p>network 网络</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 查看</span></span>
...
<span class="line"><span>podman inspect --format=&#39;{{.NetworkSettings.Networks}}&#39; mycontainer</span></span></code></pre></div><p>容器开机自动启动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 创建容器添加参数</span></span>
...
</code></pre><a href="https://docker.mirrors.ustc.edu.cn" target="_blank" rel="noreferrer">https://docker.mirrors.ustc.edu.cn</a></li></ul>`,19),l=[p];function i(r,c,o,d,h,u){return n(),s("div",null,l)}const g=a(t,[["render",i]]);export{k as __pageData,g as default};
