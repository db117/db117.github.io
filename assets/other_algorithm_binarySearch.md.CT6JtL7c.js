import{_ as s,c as a,o as p,ah as l}from"./chunks/framework.1mMYEF3_.js";const o=JSON.parse('{"title":"二分算法","description":"","frontmatter":{"title":"二分算法"},"headers":[],"relativePath":"other/algorithm/binarySearch.md","filePath":"other/algorithm/binarySearch.md"}'),e={name:"other/algorithm/binarySearch.md"};function i(t,n,c,r,h,g){return p(),a("div",null,[...n[0]||(n[0]=[l(`<h3 id="精确查找" tabindex="-1">精确查找 <a class="header-anchor" href="#精确查找" aria-label="Permalink to &quot;精确查找&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
