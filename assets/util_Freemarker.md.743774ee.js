import{_ as s,o as a,c as n,U as l}from"./chunks/framework.a49774c2.js";const d=JSON.parse('{"title":"Freemarker","description":"","frontmatter":{"title":"Freemarker"},"headers":[],"relativePath":"util/Freemarker.md","filePath":"util/Freemarker.md","lastUpdated":1690184541000}'),p={name:"util/Freemarker.md"},e=l(`<h2 id="基础语法" tabindex="-1">基础语法 <a class="header-anchor" href="#基础语法" aria-label="Permalink to &quot;基础语法&quot;">​</a></h2><h3 id="字符输出" tabindex="-1">字符输出 <a class="header-anchor" href="#字符输出" aria-label="Permalink to &quot;字符输出&quot;">​</a></h3><ul><li><p>变量存在，输出该变量，否则不输出 <code>\${emp.name?if_exists} </code></p></li><li><p>变量存在，输出该变量，否则不输出</p><pre><code>\${emp.name!}
