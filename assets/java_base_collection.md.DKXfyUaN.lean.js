import{_ as n,c as s,a3 as e,o as l}from"./chunks/framework.BChxy9sN.js";const h=JSON.parse('{"title":"java集合","description":"","frontmatter":{"title":"java集合"},"headers":[],"relativePath":"java/base/collection.md","filePath":"java/base/collection.md"}'),p={name:"java/base/collection.md"};function t(i,a,c,o,r,d){return l(),s("div",null,a[0]||(a[0]=[e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ConcurrentHashMap&lt;K,V&gt; extends AbstractMap&lt;K,V&gt;</span></span>
