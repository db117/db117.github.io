...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>全部删除</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">kubectl delete --ignore-not-found=true -f manifests/ -f manifests/setup</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li><li><p>PrometheusRule</p><blockquote><p>添加 <code>Prometheus</code>的报警规则</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">apiVersion: monitoring.coreos.com/v1</span></span>
