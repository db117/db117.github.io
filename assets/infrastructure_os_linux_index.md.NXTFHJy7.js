import{it as e,rt as t,s as n,vt as r}from"./chunks/framework.DmYqD9Nl.js";var i=JSON.parse(`{"title":"linux","description":"","frontmatter":{"title":"linux"},"headers":[],"relativePath":"infrastructure/os/linux/index.md","filePath":"infrastructure/os/linux/index.md","lastUpdated":1785221622000}`),a={name:`infrastructure/os/linux/index.md`};function o(n,i,a,o,s,c){return r(),t(`div`,null,[...i[0]||=[e(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to “备忘单”">​</a></h2><h3 id="权限" tabindex="-1">权限 <a class="header-anchor" href="#权限" aria-label="Permalink to “权限”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 将文件 file1.txt 设为所有人皆可读取</span></span>
...
<span class="line"><span>chmod -R a+r *</span></span></code></pre></div><h3 id="进程" tabindex="-1">进程 <a class="header-anchor" href="#进程" aria-label="Permalink to “进程”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 查看进程</span></span>
...
<span class="line"><span>which java</span></span></code></pre></div><h3 id="文件" tabindex="-1">文件 <a class="header-anchor" href="#文件" aria-label="Permalink to “文件”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 当前文件夹大小</span></span>
...
<span class="line"><span>gzip -d file.tar.gz</span></span></code></pre></div><h4 id="文本浏览" tabindex="-1">文本浏览 <a class="header-anchor" href="#文本浏览" aria-label="Permalink to “文本浏览”">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 显示文本内容</span></span>
...
<span class="line"><span>Q 退出less 命令</span></span></code></pre></div><h4 id="文本搜索" tabindex="-1">文本搜索 <a class="header-anchor" href="#文本搜索" aria-label="Permalink to “文本搜索”">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 搜索某个文件中，包含某个关键词的内容</span></span>
...
<span class="line"><span>grep -o -i &#39;error&#39; service.log | wc -l</span></span></code></pre></div><h4 id="文本编辑" tabindex="-1">文本编辑 <a class="header-anchor" href="#文本编辑" aria-label="Permalink to “文本编辑”">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># sed 可以接在管道上，也可以在后面指定文件</span></span>
...
<span class="line"><span>sed &#39;y/123/789/&#39;</span></span></code></pre></div><h3 id="网络" tabindex="-1">网络 <a class="header-anchor" href="#网络" aria-label="Permalink to “网络”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 查看 Tcp 连接</span></span>
...
<span class="line"><span>netstat -naptcp | grep 80</span></span></code></pre></div><h3 id="系统" tabindex="-1">系统 <a class="header-anchor" href="#系统" aria-label="Permalink to “系统”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 查看内存使用情况</span></span>
<span class="line"><span>free -m</span></span>
<span class="line"><span>top</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 查看负载情况</span></span>
<span class="line"><span>uptime</span></span></code></pre></div><h3 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to “其他”">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 打印全部环境变量</span></span>
...
<span class="line"><span>seq 9 | sed &#39;H;g&#39; | awk -v RS=&#39;&#39; &#39;{for(i=1;i&lt;=NF;i++)printf(&quot;%dx%d=%d%s&quot;, i, NR, i*NR, i==NR?&quot;\\n&quot;:&quot;\\t&quot;)}&#39;</span></span></code></pre></div><h3 id="系统参数" tabindex="-1">系统参数 <a class="header-anchor" href="#系统参数" aria-label="Permalink to “系统参数”">​</a></h3><h4 id="ulimit" tabindex="-1">ulimit <a class="header-anchor" href="#ulimit" aria-label="Permalink to “ulimit”">​</a></h4><blockquote><p>/etc/security/limits.conf</p><p>限制应用打开的文件数量</p><p>配置格式如下: <code>&lt;domain&gt; &lt;type&gt; &lt;item&gt; &lt;value&gt;</code></p><p><code>&lt;domain&gt;</code> 指定的用户或者组，可以使用通配符 * % 等 <code>&lt;type&gt;</code> 有soft，hard和-，soft指的是当前系统生效的设置值，软限制也可以理解为警告值。 hard表名系统中所能设定的最大值。soft的限制不能比hard限制高，用-表名同时设置了soft和hard的值。 <code>&lt;item&gt;</code> 设置项的名称 <code>&lt;value&gt;</code> 设置项的值</p></blockquote><p>可配置项</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># - core - limits the core file size (KB)    限制内核文件的大小。</span></span>
...
<span class="line"><span># - rtprio - max realtime pr iority</span></span></code></pre></div><p>临时修改</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 调整最大限制数量</span></span>
<span class="line"><span>ulimit -HSn 65536</span></span>
<span class="line"><span># 移除限制</span></span>
<span class="line"><span>ulimit -c unlimited</span></span></code></pre></div><p>永久修改，完后需要重新登录</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>* soft nofile 65536</span></span>
