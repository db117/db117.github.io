import{_ as s,c as n,o as a,a as e}from"./app.a840672a.js";const u=JSON.parse('{"title":"byte-buddy 简单使用","description":"","frontmatter":{"title":"byte-buddy 简单使用"},"headers":[{"level":3,"title":"主要类","slug":"主要类","link":"#主要类","children":[{"level":4,"title":"ByteBuddy","slug":"bytebuddy","link":"#bytebuddy","children":[{"level":5,"title":"常用方法","slug":"常用方法","link":"#常用方法","children":[]}]},{"level":4,"title":"NamingStrategy","slug":"namingstrategy","link":"#namingstrategy","children":[]},{"level":4,"title":"DynamicType.Builder","slug":"dynamictype-builder","link":"#dynamictype-builder","children":[{"level":5,"title":"常用方法","slug":"常用方法-1","link":"#常用方法-1","children":[]}]}]},{"level":3,"title":"常见用法","slug":"常见用法","link":"#常见用法","children":[{"level":5,"title":"继承一个类","slug":"继承一个类","link":"#继承一个类","children":[]},{"level":5,"title":"重新定义类","slug":"重新定义类","link":"#重新定义类","children":[]},{"level":5,"title":"修改方法","slug":"修改方法","link":"#修改方法","children":[]}]}],"relativePath":"java/other/bytebuddy.md","lastUpdated":1678341619000}'),l={name:"java/other/bytebuddy.md"},t=e(`<blockquote><p><a href="https://bytebuddy.net/#/tutorial" target="_blank" rel="noreferrer">Byte Buddy - runtime code generation for the Java virtual machine</a></p><p><a href="https://github.com/raphw/byte-buddy" target="_blank" rel="noreferrer">raphw/byte-buddy： Runtime code generation for the Java virtual machine. (github.com)</a></p><p>Byte Buddy是致力于解决字节码操作和 instrumentation API 的复杂性的开源框架。Byte Buddy 所声称的目标是将显式的字节码操作隐藏在一个类型安全的领域特定语言背后。通过使用 Byte Buddy，任何熟悉 Java 编程语言的人都有望非常容易地进行字节码操作。</p></blockquote><hr><h3 id="主要类" tabindex="-1">主要类 <a class="header-anchor" href="#主要类" aria-hidden="true">#</a></h3><h4 id="bytebuddy" tabindex="-1">ByteBuddy <a class="header-anchor" href="#bytebuddy" aria-hidden="true">#</a></h4><blockquote><p>核心类，用于创建DynamicType.Builder。</p></blockquote><h5 id="常用方法" tabindex="-1">常用方法 <a class="header-anchor" href="#常用方法" aria-hidden="true">#</a></h5><ul><li>subclass ：继承一个类，新类名可以通过实现<code>NamingStrategy</code>来修改默认策略</li><li>redefine：修改一个类，如果修改了方法，则源方法会丢失</li><li>rebase：修改一个类，如果修改了方法，则原方法会重命名</li></ul><h4 id="namingstrategy" tabindex="-1">NamingStrategy <a class="header-anchor" href="#namingstrategy" aria-hidden="true">#</a></h4><blockquote><p>用于子类名称生成策略</p></blockquote><h4 id="dynamictype-builder" tabindex="-1">DynamicType.Builder <a class="header-anchor" href="#dynamictype-builder" aria-hidden="true">#</a></h4><blockquote><p>核心类，添加修改字段方法等操作</p><p><code>DynamicType.Unloaded#load(java.lang.ClassLoader)</code>方法加载一个类，<strong>默认会包装一个<code>ClassLoader</code></strong>，并创建一个<code>DynamicType.Loaded</code>对象。</p><p>通过调用<code>DynamicType.Loaded#getLoaded</code>生成一个 class 对象</p></blockquote><h5 id="常用方法-1" tabindex="-1">常用方法 <a class="header-anchor" href="#常用方法-1" aria-hidden="true">#</a></h5><ul><li>method ：修改或覆盖源方法</li><li>field ：修改源字段</li><li>implement ：实现接口</li><li>defineField ：定义一个字段</li><li>defineMethod ： 定义一个方法</li><li>defineConstructor：定义一个构造函数</li><li>make：生成一个<code>DynamicType.Unloaded</code>。即未被加载的类定义。</li></ul><hr><h3 id="常见用法" tabindex="-1">常见用法 <a class="header-anchor" href="#常见用法" aria-hidden="true">#</a></h3><h5 id="继承一个类" tabindex="-1">继承一个类 <a class="header-anchor" href="#继承一个类" aria-hidden="true">#</a></h5><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">Class&lt;?&gt; type = new ByteBuddy()</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h5 id="重新定义类" tabindex="-1">重新定义类 <a class="header-anchor" href="#重新定义类" aria-hidden="true">#</a></h5><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">Foo foo = new Foo();</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  .make()</span></span>
<span class="line"><span style="color:#A6ACCD;">  .load(Foo.class.getClassLoader(), ClassReloadingStrategy.fromInstalledAgent());</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h5 id="修改方法" tabindex="-1">修改方法 <a class="header-anchor" href="#修改方法" aria-hidden="true">#</a></h5><p>固定返回值</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">class Foo {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>调用别的方法</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">class Source {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>调用默认方法（java8）</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">interface First {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  .make()</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>指定注解</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">@Retention(RetentionPolicy.RUNTIME)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    .annotateField(new RuntimeDefinitionImpl())		// 给字段添加注解</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,28),p=[t];function o(i,c,r,d,C,A){return a(),n("div",null,p)}const h=s(l,[["render",o]]);export{u as __pageData,h as default};
