import{_ as s,o as n,c as e,a3 as t}from"./chunks/framework.wJagV7l8.js";const m=JSON.parse('{"title":"JdbcTemplate","description":"","frontmatter":{"title":"JdbcTemplate"},"headers":[],"relativePath":"java/spring/JdbcTemplate.md","filePath":"java/spring/JdbcTemplate.md"}'),p={name:"java/spring/JdbcTemplate.md"};function l(o,a,i,r,c,d){return n(),e("div",null,a[0]||(a[0]=[t(`<h3 id="常规使用" tabindex="-1">常规使用 <a class="header-anchor" href="#常规使用" aria-label="Permalink to &quot;常规使用&quot;">​</a></h3><h5 id="查询出对象" tabindex="-1">查询出对象 <a class="header-anchor" href="#查询出对象" aria-label="Permalink to &quot;查询出对象&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
