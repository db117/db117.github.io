import{_ as s,c as a,o as n,a7 as e}from"./chunks/framework.Sxn4jSlr.js";const h=JSON.parse('{"title":"docker阿里云镜像安装","description":"","frontmatter":{"title":"docker阿里云镜像安装"},"headers":[],"relativePath":"ops/docker/软件安装/docker阿里云镜像安装.md","filePath":"ops/docker/软件安装/docker阿里云镜像安装.md","lastUpdated":1716896352000}'),p={name:"ops/docker/软件安装/docker阿里云镜像安装.md"},c=e(`<ul><li>配置docker阿里云yum源 (直接执行下面的命令即可)</li></ul><div class="language-cat vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cat</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>   [docker-ce-edge]</span></span>
...
<span class="line"><span>    systemctl start docker</span></span></code></pre></div>`,4),l=[c];function t(o,i,d,r,_,k){return n(),a("div",null,l)}const m=s(p,[["render",t]]);export{h as __pageData,m as default};
