import{_ as s,c as a,o as n,U as t}from"./chunks/framework.f3e3bc1f.js";const h=JSON.parse('{"title":"skywalking","description":"","frontmatter":{"title":"skywalking"},"headers":[],"relativePath":"ops/skywalking/index.md","lastUpdated":1678872629000}'),l={name:"ops/skywalking/index.md"},p=t(`<h2 id="skywalking" tabindex="-1">skywalking <a class="header-anchor" href="#skywalking" aria-label="Permalink to &quot;skywalking&quot;">​</a></h2><h3 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h3><blockquote><p>SkyWalking 是观察性分析平台和应用性能管理系统。</p><p>提供分布式追踪、服务网格遥测分析、度量聚合和可视化一体化解决方案.</p><p>支持Java, .Net Core, PHP, NodeJS, Golang, LUA语言探针</p><p>支持Envoy + Istio构建的Service Mesh</p><p><a href="https://github.com/apache/skywalking" target="_blank" rel="noreferrer">apache/skywalking: APM, Application Performance Monitoring System (github.com)</a></p><p><a href="https://skywalking.apache.org/" target="_blank" rel="noreferrer">Apache SkyWalking</a></p></blockquote><h4 id="特性" tabindex="-1">特性 <a class="header-anchor" href="#特性" aria-label="Permalink to &quot;特性&quot;">​</a></h4><ul><li>多种监控手段，语言探针和service mesh</li><li>多语言自动探针，Java, .Net Core, PHP, NodeJS, Golang, LUA</li><li>轻量高效，不需要大数据</li><li>模块化，UI、存储、集群管理多种机制可选</li><li>支持告警</li><li>优秀的可视化方案</li></ul><h2 id="文件下载" tabindex="-1">文件下载 <a class="header-anchor" href="#文件下载" aria-label="Permalink to &quot;文件下载&quot;">​</a></h2><p><a href="https://skywalking.apache.org/downloads/" target="_blank" rel="noreferrer">Downloads | Apache SkyWalking</a></p><h2 id="文件夹介绍" tabindex="-1">文件夹介绍 <a class="header-anchor" href="#文件夹介绍" aria-label="Permalink to &quot;文件夹介绍&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">├── README.txt</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,9),e=[p];function o(i,c,r,A,C,y){return n(),a("div",null,e)}const D=s(l,[["render",o]]);export{h as __pageData,D as default};
