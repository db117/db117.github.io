import{_ as e,o as p,c as t,j as n,ah as a}from"./chunks/framework.BM5zFche.js";const b=JSON.parse('{"title":"spring-boot启动流程","description":"","frontmatter":{"title":"spring-boot启动流程"},"headers":[],"relativePath":"java/spring-boot/startup.md","filePath":"java/spring-boot/startup.md","lastUpdated":1784602594000}'),i={name:"java/spring-boot/startup.md"};function o(l,s,r,c,d,g){return p(),t("div",null,[...s[0]||(s[0]=[n("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60f69a560e3e74596bab3b71"},null,-1),a(`<h3 id="执行启动类的mian" tabindex="-1">执行启动类的mian <a class="header-anchor" href="#执行启动类的mian" aria-label="Permalink to &quot;执行启动类的mian&quot;">​</a></h3><blockquote><p>解压后的目录结构</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├── BOOT-INF</span></span>
...
<span class="line"><span>  java.lang.ClassLoader#loadClass(java.lang.String, boolean)</span></span></code></pre></div><h3 id="启动类main" tabindex="-1">启动类main <a class="header-anchor" href="#启动类main" aria-label="Permalink to &quot;启动类main&quot;">​</a></h3><blockquote><p>主要启动流程都在启动类main中。</p></blockquote>`,10),n("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/6602795e878a3f700d429747"},null,-1),a(`<p><strong>run</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public ConfigurableApplicationContext run(String... args) {</span></span>
