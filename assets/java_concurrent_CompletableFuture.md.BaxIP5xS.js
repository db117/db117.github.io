...
<span class="line"><span>public static &lt;U&gt; CompletableFuture&lt;U&gt; supplyAsync(Supplier&lt;U&gt; supplier, Executor executor)</span></span></code></pre></div><h3 id="获取结果" tabindex="-1">获取结果 <a class="header-anchor" href="#获取结果" aria-label="Permalink to &quot;获取结果&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// get 方法需要用户处理异常</span></span>
<span class="line"><span>get(long timeout, TimeUnit unit)</span></span>
<span class="line"><span>get()</span></span>
<span class="line"><span></span></span>
<span class="line"><span>join()</span></span></code></pre></div><h3 id="结果处理" tabindex="-1">结果处理 <a class="header-anchor" href="#结果处理" aria-label="Permalink to &quot;结果处理&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 任务结束了进行处理</span></span>
...
<span class="line"><span>public CompletableFuture&lt;T&gt; exceptionallyComposeAsync(Function&lt;Throwable, ? extends CompletionStage&lt;T&gt;&gt; fn,Executor executor)</span></span></code></pre></div><h2 id="使用场景" tabindex="-1">使用场景 <a class="header-anchor" href="#使用场景" aria-label="Permalink to &quot;使用场景&quot;">​</a></h2><h3 id="异步任务" tabindex="-1">异步任务 <a class="header-anchor" href="#异步任务" aria-label="Permalink to &quot;异步任务&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CompletableFuture&lt;String&gt; future = CompletableFuture.supplyAsync(() -&gt; {</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span></span></span>
<span class="line"><span>String result = future.get(); // 阻塞等待任务完成并获取结果</span></span></code></pre></div><h3 id="并行任务的执行" tabindex="-1">并行任务的执行 <a class="header-anchor" href="#并行任务的执行" aria-label="Permalink to &quot;并行任务的执行&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CompletableFuture&lt;String&gt; request1 = CompletableFuture.supplyAsync(() -&gt; performNetworkRequest1());</span></span>
...
<span class="line"><span>});</span></span></code></pre></div><h3 id="异常处理和容错机制" tabindex="-1">异常处理和容错机制 <a class="header-anchor" href="#异常处理和容错机制" aria-label="Permalink to &quot;异常处理和容错机制&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CompletableFuture&lt;String&gt; future = CompletableFuture.supplyAsync(() -&gt; {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>});</span></span></code></pre></div><h3 id="替代-java-util-concurrent-countdownlatch-的功能" tabindex="-1">替代 <code>java.util.concurrent.CountDownLatch</code> 的功能 <a class="header-anchor" href="#替代-java-util-concurrent-countdownlatch-的功能" aria-label="Permalink to &quot;替代 \`java.util.concurrent.CountDownLatch\` 的功能&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import java.util.concurrent.CompletableFuture;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,31),t=[l];function o(i,c,u,r,d,h){return s(),a("div",null,t)}const g=n(p,[["render",o]]);export{m as __pageData,g as default};
