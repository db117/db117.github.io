...
<span class="line"><span>    implements java.io.Serializable, Cloneable</span></span></code></pre></div><ul><li>保存数据的数组大小为枚举的数量</li><li>操作数组使用<code>java.lang.Enum#ordinal</code>当index</li></ul><h3 id="concurrenthashmap-线程安全" tabindex="-1">ConcurrentHashMap(线程安全) <a class="header-anchor" href="#concurrenthashmap-线程安全" aria-label="Permalink to &quot;ConcurrentHashMap(线程安全)&quot;">​</a></h3><blockquote><p>最常用的线程安全map，主要结构跟 <code>hashmap</code>差不多。</p><p>synchronized 只锁定当前链表或红⿊⼆叉树的⾸节点，这样只要 hash 不冲突，就不会产⽣并发，效率⼜提升 N 倍。</p></blockquote><h5 id="concurrenthashmap流程图" tabindex="-1">ConcurrentHashMap流程图 <a class="header-anchor" href="#concurrenthashmap流程图" aria-label="Permalink to &quot;ConcurrentHashMap流程图&quot;">​</a></h5>`,47),c=a("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/61b6ee4a1efad42237b9a3ac"},null,-1),o=s(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ConcurrentHashMap&lt;K,V&gt; extends AbstractMap&lt;K,V&gt;</span></span>
...
<span class="line"><span>    implements BlockingDeque&lt;E&gt;, java.io.Serializable {</span></span></code></pre></div>`,76),r=[t,i,c,o];function d(u,h,b,g,k,m){return p(),e("div",null,r)}const q=n(l,[["render",d]]);export{y as __pageData,q as default};
