import{_ as a,c as s,o as n,a8 as t}from"./chunks/framework.n88ns4tz.js";const f=JSON.parse('{"title":"prometheus","description":"","frontmatter":{"title":"prometheus"},"headers":[],"relativePath":"ops/prometheus/index.md","filePath":"ops/prometheus/index.md","lastUpdated":1712285624000}'),e={name:"ops/prometheus/index.md"},l=t(`<h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h2><blockquote><p><a href="https://prometheus.io/" target="_blank" rel="noreferrer">官网</a></p><p><a href="https://github.com/prometheus" target="_blank" rel="noreferrer">Prometheus (github.com)</a></p><p>基于时序数据库的开源监控告警系统</p></blockquote><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h2><blockquote><p>官方配置文档 <a href="https://prometheus.io/docs/prometheus/latest/configuration/configuration/" target="_blank" rel="noreferrer">Configuration | Prometheus</a></p><p>下面记录一下经常修改的配置文件</p></blockquote><h3 id="启动配置" tabindex="-1">启动配置 <a class="header-anchor" href="#启动配置" aria-label="Permalink to &quot;启动配置&quot;">​</a></h3><ul><li><code>--web.external-url=prometheus</code><ul><li>指定访问路径前缀，在需要挂在某个域名的路径下并代理的情况下使用</li></ul></li></ul><h3 id="通用" tabindex="-1">通用 <a class="header-anchor" href="#通用" aria-label="Permalink to &quot;通用&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>global:</span></span>
...
<span class="line"><span>  [ - &lt;http_sd_config&gt; ... ]</span></span></code></pre></div><h3 id="rules" tabindex="-1">rules <a class="header-anchor" href="#rules" aria-label="Permalink to &quot;rules&quot;">​</a></h3><blockquote><p>记录规则,可以预先计算经常需要或计算量大的表达式，并将其结果保存为一组新的时间序列</p><p>警报规则允许您基于 Prometheus 表达式语言表达式定义警报条件，并向外部服务发送有关发射警报的通知。每当警报表达式在给定时间点产生一个或多个向量元素时，警报对这些元素的标签集计为活动的。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>groups: #  分组</span></span>
...
<span class="line"><span>{{ end }}</span></span></code></pre></div>`,29),p=[l];function i(r,c,o,d,g,h){return n(),s("div",null,p)}const b=a(e,[["render",i]]);export{f as __pageData,b as default};
