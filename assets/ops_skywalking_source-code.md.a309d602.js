import{_ as n,c as a,o as l,a as s,b as e}from"./app.a840672a.js";const h=JSON.parse('{"title":"源码分析","description":"","frontmatter":{"title":"源码分析"},"headers":[{"level":3,"title":"oap server","slug":"oap-server","link":"#oap-server","children":[{"level":4,"title":"目录结构","slug":"目录结构","link":"#目录结构","children":[{"level":5,"title":"主要类以及接口","slug":"主要类以及接口","link":"#主要类以及接口","children":[]}]}]},{"level":3,"title":"Java agent","slug":"java-agent","link":"#java-agent","children":[{"level":4,"title":"目录结构","slug":"目录结构-1","link":"#目录结构-1","children":[]},{"level":4,"title":"流程图","slug":"流程图","link":"#流程图","children":[]},{"level":4,"title":"主要类","slug":"主要类","link":"#主要类","children":[]}]},{"level":2,"title":"","slug":"","link":"#","children":[]}],"relativePath":"ops/skywalking/source-code.md","lastUpdated":1678341619000}'),p={name:"ops/skywalking/source-code.md"},t=s(`<h3 id="oap-server" tabindex="-1">oap server <a class="header-anchor" href="#oap-server" aria-hidden="true">#</a></h3><blockquote><p><a href="https://github.com/apache/skywalking" target="_blank" rel="noreferrer">apache/skywalking: APM, Application Performance Monitoring System (github.com)</a></p><p><a href="https://skywalking.apache.org/" target="_blank" rel="noreferrer">Apache SkyWalking</a></p><p>服务端主流程源码分析。</p></blockquote><h4 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">oap-server</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h5 id="主要类以及接口" tabindex="-1">主要类以及接口 <a class="header-anchor" href="#主要类以及接口" aria-hidden="true">#</a></h5><ul><li>OAPServerStartUp：启动类</li><li>ApplicationConfigLoader：加载配置</li><li>ModuleManager：加载各种模块</li><li>ModuleProvider：提供服务类，主要通过 <code>prepare</code>，<code>start</code>，<code>notifyAfterCompleted</code>实现各种个功能</li><li>ModuleConfig：各种插件配置类</li><li>ISource：数据对象</li><li>GRPCHandlerRegister：GRPC 处理器注册</li><li>JettyHandlerRegister：jetty 处理器注册</li></ul><h3 id="java-agent" tabindex="-1">Java agent <a class="header-anchor" href="#java-agent" aria-hidden="true">#</a></h3><blockquote><p>Java 客户端,搜集各种数据发送到服务端。</p><p><a href="https://github.com/apache/skywalking-java" target="_blank" rel="noreferrer">apache/skywalking-java: The Java agent for Apache SkyWalking (github.com)</a></p></blockquote><h4 id="目录结构-1" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构-1" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">├── docs														文档</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="流程图" tabindex="-1">流程图 <a class="header-anchor" href="#流程图" aria-hidden="true">#</a></h4>`,11),o=e("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/621347b66376897c8c8308a3"},null,-1),r=s('<h4 id="主要类" tabindex="-1">主要类 <a class="header-anchor" href="#主要类" aria-hidden="true">#</a></h4><ul><li>SkyWalkingAgent：启动类</li><li>Config：所有配置都在这个类中。</li><li>BootService：所有服务的顶级接口</li><li>TracingContext：核心类，主要用来创建 span</li><li>GlobalIdGenerator：生成 <code>traceId</code> ，第一部分为<code>实例 id</code>，第二部分为<code>线程 id</code>，第三部分为时间戳（毫秒）+当前线程中的序列号[0,9999]</li><li>AbstractSpan：各种插件使用</li></ul><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h2>',3),c=[t,o,r];function i(C,A,y,g,d,D){return l(),a("div",null,c)}const m=n(p,[["render",i]]);export{h as __pageData,m as default};
