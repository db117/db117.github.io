import{_ as a,o as s,c as n,R as e}from"./chunks/framework.H_1uJR_t.js";const g=JSON.parse('{"title":"PostgreSQL","description":"","frontmatter":{"title":"PostgreSQL"},"headers":[],"relativePath":"database/postgreSql/index.md","filePath":"database/postgreSql/index.md","lastUpdated":1699241780000}'),p={name:"database/postgreSql/index.md"},l=e(`<h4 id="不存在则插入-存在则更新" tabindex="-1">不存在则插入/存在则更新 <a class="header-anchor" href="#不存在则插入-存在则更新" aria-label="Permalink to &quot;不存在则插入/存在则更新&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>-- 1、主键id不重复就插入，否则更新</span></span>
...
<span class="line"><span>SELECT pg_has_role(current_user, &#39;pg_monitor&#39;, &#39;member&#39;);</span></span></code></pre></div>`,11),i=[l];function t(o,c,d,r,h,u){return s(),n("div",null,i)}const b=a(p,[["render",t]]);export{g as __pageData,b as default};
