import{_ as s,o as n,c as e,ah as l}from"./chunks/framework.BM5zFche.js";const u=JSON.parse('{"title":"openwrt 编译","description":"","frontmatter":{"title":"openwrt 编译"},"headers":[],"relativePath":"other/openwrt.md","filePath":"other/openwrt.md","lastUpdated":1784602594000}'),p={name:"other/openwrt.md"};function i(t,a,o,c,r,d){return n(),e("div",null,[...a[0]||(a[0]=[l(`<h3 id="仓库" tabindex="-1">仓库 <a class="header-anchor" href="#仓库" aria-label="Permalink to &quot;仓库&quot;">​</a></h3><p>openwrt 源码</p><p><a href="https://github.com/coolsnowwolf/lede" target="_blank" rel="noreferrer">coolsnowwolf/lede: Lean&#39;s LEDE source (github.com)</a></p><p>常用插件</p><p><a href="https://github.com/kenzok8/openwrt-packages" target="_blank" rel="noreferrer">kenzok8/openwrt-packages: openwrt常用软件包 (github.com)</a></p><h3 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 依赖</span></span>
