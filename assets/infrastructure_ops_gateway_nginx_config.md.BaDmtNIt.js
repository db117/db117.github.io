import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"Nginx 配置","description":"","frontmatter":{"title":"Nginx 配置"},"headers":[],"relativePath":"infrastructure/ops/gateway/nginx/config.md","filePath":"infrastructure/ops/gateway/nginx/config.md","lastUpdated":1786437432000}`),a={name:`infrastructure/ops/gateway/nginx/config.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<h1 id="nginx配置" tabindex="-1">Nginx配置 <a class="header-anchor" href="#nginx配置" aria-label="Permalink to “Nginx配置”">​</a></h1><h2 id="核心配置" tabindex="-1">核心配置 <a class="header-anchor" href="#核心配置" aria-label="Permalink to “核心配置”">​</a></h2><h3 id="文件结构" tabindex="-1">文件结构 <a class="header-anchor" href="#文件结构" aria-label="Permalink to “文件结构”">​</a></h3><ul><li><code>main</code> 全局配置，对全局生效；</li><li><code>events</code> 配置影响 <code>Nginx</code> 服务器与用户的网络连接；</li><li><code>http</code> 配置代理，缓存，日志定义等绝大多数功能和第三方模块的配置；</li><li><code>server</code> 配置虚拟主机的相关参数，一个 <code>http</code> 块中可以有多个 <code>server</code> 块；</li><li><code>location</code> 用于配置匹配的 <code>uri</code> ；</li><li><code>upstream</code> 配置后端服务器具体地址，负载均衡配置不可或缺的部分；</li></ul><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># main段配置信息</span></span>
...
<span class="line"><span>&quot;;</span></span>
<span class="line"><span> }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="常用配置" tabindex="-1">常用配置 <a class="header-anchor" href="#常用配置" aria-label="Permalink to “常用配置”">​</a></h2><h3 id="负载均衡" tabindex="-1">负载均衡 <a class="header-anchor" href="#负载均衡" aria-label="Permalink to “负载均衡”">​</a></h3><ul><li><p><code>server</code> 定义上游服务器地址；</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>语法：server address [parameters]</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>down 标记服务器长期不可用，离线维护；</span></span></code></pre></div></li><li><p><code>zone</code> 定义共享内存，用于跨 <code>worker</code> 子进程；</p></li><li><p><code>keepalive</code> 对上游服务启用长连接；</p></li><li><p><code>keepalive_requests</code> 一个长连接最多请求 <code>HTTP</code> 的个数；默认1000</p></li><li><p><code>keepalive_timeout</code> 空闲情形下，一个长连接的超时时长 默认60s</p></li><li><p><code>keepalive_time</code>一个连接最长时间 默认1h</p></li></ul><p>负载均衡类型</p><ul><li><p><code>hash</code> 哈希负载均衡算法；</p></li><li><p><code>ip_hash</code> 依据 <code>IP</code> 进行哈希计算的负载均衡算法；</p></li><li><p><code>random</code> 随机负载均衡算法；</p></li><li><p><code>least_conn</code> 最少连接数负载均衡算法；</p></li><li><p><code>least_time</code> 最短响应时间负载均衡算法；</p></li></ul><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>upstream dynamic {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="proxy-pass" tabindex="-1">proxy_pass <a class="header-anchor" href="#proxy-pass" aria-label="Permalink to “proxy_pass”">​</a></h3><blockquote><p>代理转发</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span> location / {</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div>`,18)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};