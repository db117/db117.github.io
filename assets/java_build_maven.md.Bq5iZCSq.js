import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"maven","description":"","frontmatter":{"title":"maven"},"headers":[],"relativePath":"java/build/maven.md","filePath":"java/build/maven.md","lastUpdated":1786586539000}`),a={name:`java/build/maven.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to “备忘单”">​</a></h2><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>#	打包跳过编译失败</span></span>
...
<span class="line"><span>mvn clean package -P test</span></span></code></pre></div><p>pom配置</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span> </span></span>
...
<span class="line"><span> &lt;/properties&gt;</span></span></code></pre></div><h2 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to “其他”">​</a></h2><h4 id="优雅的替换第三方依赖中的类" tabindex="-1">优雅的替换第三方依赖中的类 <a class="header-anchor" href="#优雅的替换第三方依赖中的类" aria-label="Permalink to “优雅的替换第三方依赖中的类”">​</a></h4><p>在项目中需要依赖其他第三方的jar包，但有时需要扩展第三方jar的功能，或者修复依赖中已知还未修复的bug，但碰到过很多种情况，第三方类库中并没有提供对应的扩展点导致无法优雅的使用继承等方法对代码进行改造。</p><p>特别是针对与<code>jar</code>中还有验签的情况下，直接在<strong>本项目中添加一个限定名一样的类是会报异常的</strong>。</p><p>添加<code>maven-dependency-plugin</code>，在打包的时候把需要替换jar里面的类（<strong>要排除被替换的类）</strong>copy到当前项目的<code>classes</code>中。</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>&lt;plugin&gt;</span></span>
...
<span class="line"><span>       &lt;/execution&gt;</span></span>
<span class="line"><span>    &lt;/executions&gt;</span></span>
<span class="line"><span>&lt;/plugin&gt;</span></span></code></pre></div><h4 id="使用maven自动将源码打包并发布" tabindex="-1">使用maven自动将源码打包并发布 <a class="header-anchor" href="#使用maven自动将源码打包并发布" aria-label="Permalink to “使用maven自动将源码打包并发布”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>&lt;!-- Source attach plugin --&gt;</span></span>
...
<span class="line"><span>        &lt;/execution&gt;</span></span>
<span class="line"><span>    &lt;/executions&gt;</span></span>
<span class="line"><span>&lt;/plugin&gt;</span></span></code></pre></div><p>注意：在多项目构建中，将source-plugin置于顶层或parent的pom中并不会发挥作用，必须置于具体项目的pom中。</p><hr><h4 id="获取git信息" tabindex="-1">获取git信息 <a class="header-anchor" href="#获取git信息" aria-label="Permalink to “获取git信息”">​</a></h4><blockquote><p>使用插件 <a href="https://github.com/git-commit-id/git-commit-id-maven-plugin" target="_blank" rel="noreferrer">git-commit-id/git-commit-id-maven-plugin</a></p><p>5.0 开始不支持<code>jdk1.8</code>了，而且变了 <code>groupId</code>和 <code>artifactId</code>。</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>			&lt;plugin&gt;</span></span>
...
<span class="line"><span>                &lt;/configuration&gt;</span></span>
<span class="line"><span>            &lt;/plugin&gt;</span></span></code></pre></div><p>默认的参数</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>git.tags=\${git.tags}</span></span>
