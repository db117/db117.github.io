import{_ as a,c as s,o as n,a8 as e}from"./chunks/framework.BaglXmoE.js";const g=JSON.parse('{"title":"PostgreSQL","description":"","frontmatter":{"title":"PostgreSQL"},"headers":[],"relativePath":"database/postgreSql/index.md","filePath":"database/postgreSql/index.md","lastUpdated":1710641614000}'),p={name:"database/postgreSql/index.md"},l=e(`<h4 id="不存在则插入-存在则更新" tabindex="-1">不存在则插入/存在则更新 <a class="header-anchor" href="#不存在则插入-存在则更新" aria-label="Permalink to &quot;不存在则插入/存在则更新&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>-- 1、主键id不重复就插入，否则更新</span></span>
