import{_ as s,o as a,c as n,U as e}from"./chunks/framework.a49774c2.js";const h=JSON.parse('{"title":"docker","description":"","frontmatter":{"title":"docker"},"headers":[],"relativePath":"ops/docker/index.md","filePath":"ops/docker/index.md","lastUpdated":1690184541000}'),l={name:"ops/docker/index.md"},t=e(`<blockquote><p><a href="https://www.docker.com/" target="_blank" rel="noreferrer">Docker: Accelerated, Containerized Application Development</a></p></blockquote><h2 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h2><p>常规操作</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 进入容器</span></span>
...
<span class="line"><span style="color:#A6ACCD;">docker inspect --format &#39;{{ .State.Pid }}&#39;  4ddf4638572d</span></span></code></pre></div><p>删除容器</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 批量删除镜像或容器</span></span>
...
<span class="line"><span style="color:#A6ACCD;">docker system prune</span></span></code></pre></div><p>network 网络</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 查看</span></span>
...
<span class="line"><span style="color:#A6ACCD;">podman inspect --format=&#39;{{.NetworkSettings.Networks}}&#39; mycontainer</span></span></code></pre></div><p>容器开机自动启动</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 创建容器添加参数</span></span>
...
</code></pre><a href="https://docker.mirrors.ustc.edu.cn" target="_blank" rel="noreferrer">https://docker.mirrors.ustc.edu.cn</a></li></ul>`,19),o=[t];function p(r,c,i,d,C,A){return a(),n("div",null,o)}const m=s(l,[["render",p]]);export{h as __pageData,m as default};
