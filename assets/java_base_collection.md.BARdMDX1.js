import{_ as e,o as p,c as l,j as s,ah as n}from"./chunks/framework.BM5zFche.js";const b=JSON.parse('{"title":"java集合","description":"","frontmatter":{"title":"java集合"},"headers":[],"relativePath":"java/base/collection.md","filePath":"java/base/collection.md","lastUpdated":1783679877000}'),t={name:"java/base/collection.md"};function i(c,a,o,r,d,u){return p(),l("div",null,[...a[0]||(a[0]=[s("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60e5834f6376892c1ec611af"},null,-1),n(`<h2 id="list" tabindex="-1">List <a class="header-anchor" href="#list" aria-label="Permalink to &quot;List&quot;">​</a></h2><h3 id="arraylist" tabindex="-1">ArrayList <a class="header-anchor" href="#arraylist" aria-label="Permalink to &quot;ArrayList&quot;">​</a></h3><blockquote><p><code>java.util.ArrayList</code></p><p>最常用的集合,实现方式为数组</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ArrayList&lt;E&gt; extends AbstractList&lt;E&gt;</span></span>
<span class="line"><span>        implements List&lt;E&gt;, RandomAccess, Cloneable, java.io.Serializable</span></span></code></pre></div><ul><li><p>使用<code>transient Object[] elementData;</code>来保存数据，默认大小为10</p></li><li><p>每一次扩容为之前的1.5倍<code>int newCapacity = oldCapacity + (oldCapacity &gt;&gt; 1);</code></p></li><li><p>标记为java.util.RandomAccess，可进行随机访问</p></li><li><p>删除元素需要调用 <code>System.arraycopy()</code> 将 index+1 后面的元素都复制到 index 位置上，该操作的时间复杂度为 O(N)</p></li><li><p>subList</p><blockquote><p>访问时通过指定 index 来实现，添加修改会改变原来的 List</p></blockquote></li><li><p><code>java.util.Arrays.ArrayList</code>为<code>Arrays</code>的实现，不能修改。但是可以get，set</p></li></ul><h3 id="linkedlist" tabindex="-1">LinkedList <a class="header-anchor" href="#linkedlist" aria-label="Permalink to &quot;LinkedList&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class LinkedList&lt;E&gt;</span></span>
<span class="line"><span>    extends AbstractSequentialList&lt;E&gt;</span></span>
<span class="line"><span>    implements List&lt;E&gt;, Deque&lt;E&gt;, Cloneable, java.io.Serializable</span></span></code></pre></div><blockquote><p><code>java.util.LinkedList</code></p><p>相比ArrayList多实现了java.util.Deque接口</p><p>使用双向链表来保存数据</p></blockquote><ul><li>不要通过index进行操作，会遍历链表</li></ul><h3 id="vector-线程安全" tabindex="-1">Vector(线程安全) <a class="header-anchor" href="#vector-线程安全" aria-label="Permalink to &quot;Vector(线程安全)&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Vector&lt;E&gt;</span></span>
<span class="line"><span>    extends AbstractList&lt;E&gt;</span></span>
<span class="line"><span>    implements List&lt;E&gt;, RandomAccess, Cloneable, java.io.Serializable</span></span></code></pre></div><blockquote><p><code>java.util.Vector</code></p><p>跟java.util.ArrayList类似，不过接口通过synchronized来保证并发安全</p></blockquote><ul><li>扩容直接翻倍</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 容量满了后，如果设置了capacityIncrement这按照设置的数量进行增加，否则翻倍</span></span>
<span class="line"><span>int newCapacity = oldCapacity + ((capacityIncrement &gt; 0) ?</span></span>
<span class="line"><span>                                 capacityIncrement : oldCapacity);</span></span></code></pre></div><h3 id="stack-线程安全" tabindex="-1">Stack(线程安全) <a class="header-anchor" href="#stack-线程安全" aria-label="Permalink to &quot;Stack(线程安全)&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Stack&lt;E&gt; extends Vector&lt;E&gt;</span></span></code></pre></div><blockquote><p><code>java.util.Stack</code></p><p>直接继承自<code>java.util.Vector</code></p><p>实现stack数据结构</p></blockquote><h3 id="copyonwritearraylist-线程安全" tabindex="-1">CopyOnWriteArrayList(线程安全) <a class="header-anchor" href="#copyonwritearraylist-线程安全" aria-label="Permalink to &quot;CopyOnWriteArrayList(线程安全)&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class CopyOnWriteArrayList&lt;E&gt;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="treemap" tabindex="-1">TreeMap <a class="header-anchor" href="#treemap" aria-label="Permalink to &quot;TreeMap&quot;">​</a></h3><blockquote><p>TreeMap的实现是红黑树算法的实现</p><p>为有序map</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class TreeMap&lt;K,V&gt;</span></span>
...
<span class="line"><span>    private static final boolean BLACK = true;</span></span></code></pre></div><h3 id="hashtable-线程安全" tabindex="-1">Hashtable(线程安全) <a class="header-anchor" href="#hashtable-线程安全" aria-label="Permalink to &quot;Hashtable(线程安全)&quot;">​</a></h3><blockquote><p>很古老的线程安全的map</p><p>可以简单粗暴的理解为对 hashmap 的修改方法加锁</p><p>推荐使用 <code>java.util.concurrent.ConcurrentHashMap</code></p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Hashtable&lt;K,V&gt;</span></span>
<span class="line"><span>    extends Dictionary&lt;K,V&gt;</span></span>
<span class="line"><span>    implements Map&lt;K,V&gt;, Cloneable, java.io.Serializable</span></span></code></pre></div><h3 id="identityhashmap" tabindex="-1">IdentityHashMap <a class="header-anchor" href="#identityhashmap" aria-label="Permalink to &quot;IdentityHashMap&quot;">​</a></h3><blockquote><p><code>Hashmap</code> 使用 equals 来比较是否相等，而<code>IdentityHashMap</code>使用 ==</p><p><strong>不是Map的通用实现</strong>，它有意违反了Map的常规协定。并且IdentityHashMap允许key和value都为null</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class IdentityHashMap&lt;K,V&gt;</span></span>
<span class="line"><span>    extends AbstractMap&lt;K,V&gt;</span></span>
<span class="line"><span>    implements Map&lt;K,V&gt;, java.io.Serializable, Cloneable</span></span></code></pre></div><h3 id="linkedhashmap" tabindex="-1">LinkedHashMap <a class="header-anchor" href="#linkedhashmap" aria-label="Permalink to &quot;LinkedHashMap&quot;">​</a></h3><blockquote><p>继承自<code>HashMap</code>，添加双向链表来保证迭代循序</p><p>通过重写 newNode 和 newTreeNode 来说实现添加数据放入队尾</p><p>可扩展实现 LRU 缓存</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class LinkedHashMap&lt;K,V&gt;</span></span>
...
<span class="line"><span>    void afterNodeRemoval(Node&lt;K,V&gt; p) { }</span></span></code></pre></div><h3 id="weakhashmap" tabindex="-1">WeakHashMap <a class="header-anchor" href="#weakhashmap" aria-label="Permalink to &quot;WeakHashMap&quot;">​</a></h3><blockquote><p>主要是用在内存敏感的系统中，当缓存使用</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class WeakHashMap&lt;K,V&gt;</span></span>
<span class="line"><span>    extends AbstractMap&lt;K,V&gt;</span></span>
<span class="line"><span>    implements Map&lt;K,V&gt; </span></span>
<span class="line"><span>    </span></span>
...
<span class="line"><span>    private void expungeStaleEntries() {}</span></span></code></pre></div><h3 id="enummap" tabindex="-1">EnumMap <a class="header-anchor" href="#enummap" aria-label="Permalink to &quot;EnumMap&quot;">​</a></h3><blockquote><p>key 必须为<code>Eunm</code>的map</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class EnumMap&lt;K extends Enum&lt;K&gt;, V&gt; extends AbstractMap&lt;K, V&gt;</span></span>
<span class="line"><span>    implements java.io.Serializable, Cloneable</span></span></code></pre></div><ul><li>保存数据的数组大小为枚举的数量</li><li>操作数组使用<code>java.lang.Enum#ordinal</code>当index</li></ul><h3 id="concurrenthashmap-线程安全" tabindex="-1">ConcurrentHashMap(线程安全) <a class="header-anchor" href="#concurrenthashmap-线程安全" aria-label="Permalink to &quot;ConcurrentHashMap(线程安全)&quot;">​</a></h3><blockquote><p>最常用的线程安全map，主要结构跟 <code>hashmap</code>差不多。</p><p>synchronized 只锁定当前链表或红⿊⼆叉树的⾸节点，这样只要 hash 不冲突，就不会产⽣并发，效率⼜提升 N 倍。</p></blockquote><h5 id="concurrenthashmap流程图" tabindex="-1">ConcurrentHashMap流程图 <a class="header-anchor" href="#concurrenthashmap流程图" aria-label="Permalink to &quot;ConcurrentHashMap流程图&quot;">​</a></h5>`,47),s("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/61b6ee4a1efad42237b9a3ac"},null,-1),n(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class ConcurrentHashMap&lt;K,V&gt; extends AbstractMap&lt;K,V&gt;</span></span>
...
<span class="line"><span>    }</span></span></code></pre></div><h2 id="queue" tabindex="-1">Queue <a class="header-anchor" href="#queue" aria-label="Permalink to &quot;Queue&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface Queue&lt;E&gt; extends Collection&lt;E&gt;</span></span></code></pre></div><h3 id="priorityqueue" tabindex="-1">PriorityQueue <a class="header-anchor" href="#priorityqueue" aria-label="Permalink to &quot;PriorityQueue&quot;">​</a></h3><blockquote><p>基于优先堆的一个无界队列，这个优先队列中的元素可以默认自然排序或者通过提供的比较器在队列实例化的时排序。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class PriorityQueue&lt;E&gt; extends AbstractQueue&lt;E&gt;</span></span>
...
<span class="line"><span>    implements BlockingDeque&lt;E&gt;, java.io.Serializable {</span></span></code></pre></div>`,76)])])}const g=e(t,[["render",i]]);export{b as __pageData,g as default};
