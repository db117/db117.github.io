import{_ as s,c as n,o as a,a as l}from"./app.5745f82f.js";const y=JSON.parse('{"title":"客户端配置","description":"","frontmatter":{"title":"客户端配置"},"headers":[{"level":3,"title":"常用设置","slug":"常用设置","link":"#常用设置","children":[]}],"relativePath":"ops/skywalking/client-config.md","lastUpdated":1677837613000}'),p={name:"ops/skywalking/client-config.md"},e=l(`<h3 id="常用设置" tabindex="-1">常用设置 <a class="header-anchor" href="#常用设置" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"># 设置Agent命名空间，它用来隔离追踪和监控数据，当两个应用使用不同的名称空间时，跨进程传播链会中断。</span></span>
