...
<span class="line"><span>  java.lang.ClassLoader#loadClass(java.lang.String, boolean)</span></span></code></pre></div><h3 id="启动类main" tabindex="-1">启动类main <a class="header-anchor" href="#启动类main" aria-label="Permalink to &quot;启动类main&quot;">​</a></h3><blockquote><p>主要启动流程都在启动类main中。</p></blockquote>`,10),l=n("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/6602795e878a3f700d429747"},null,-1),r=a(`<p><strong>run</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public ConfigurableApplicationContext run(String... args) {</span></span>
