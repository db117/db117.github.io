import{_ as s,c as n,o as a,a as l}from"./app.a840672a.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":4,"title":"配置文件","slug":"配置文件","link":"#配置文件","children":[]},{"level":4,"title":"http 转 https","slug":"http-转-https","link":"#http-转-https","children":[]}],"relativePath":"ops/nginx/nginx-https.md","lastUpdated":1678341619000}'),p={name:"ops/nginx/nginx-https.md"},e=l(`<h4 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">#user  nobody;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">		return 301 https://$http_host$request_uri;</span></span>
<span class="line"><span style="color:#A6ACCD;">	}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,4),t=[e];function o(c,r,C,i,A,y){return a(),n("div",null,t)}const h=s(p,[["render",o]]);export{_ as __pageData,h as default};
