import{_ as s,o as n,c as a,U as t}from"./chunks/framework.190aac23.js";const y=JSON.parse('{"title":"json 相关","description":"","frontmatter":{"title":"json 相关"},"headers":[],"relativePath":"database/sqlserver/josn.md","filePath":"database/sqlserver/josn.md","lastUpdated":1689063504000}'),o={name:"database/sqlserver/josn.md"},l=t(`<h1 id="json-基本操作" tabindex="-1">JSON 基本操作 <a class="header-anchor" href="#json-基本操作" aria-label="Permalink to &quot;JSON 基本操作&quot;">​</a></h1><blockquote><p><a href="https://docs.microsoft.com/zh-cn/sql/relational-databases/json/json-data-sql-server?view=sql-server-ver15" target="_blank" rel="noreferrer">使用 JSON 数据 - SQL Server | Microsoft Docs</a></p></blockquote><h3 id="将查询结果格式化为-json" tabindex="-1">将查询结果格式化为 JSON <a class="header-anchor" href="#将查询结果格式化为-json" aria-label="Permalink to &quot;将查询结果格式化为 JSON&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">SELECT name, surname  </span></span>
<span class="line"><span style="color:#A6ACCD;">FROM emp  </span></span>
<span class="line"><span style="color:#A6ACCD;">FOR JSON AUTO;</span></span></code></pre></div><h3 id="获取-json-数据" tabindex="-1">获取 json 数据 <a class="header-anchor" href="#获取-json-数据" aria-label="Permalink to &quot;获取 json 数据&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">DECLARE @jsonInfo NVARCHAR(MAX)</span></span>
...
<span class="line"><span style="color:#A6ACCD;"> }&#39; </span></span>
<span class="line"><span style="color:#A6ACCD;"> </span></span>
<span class="line"><span style="color:#A6ACCD;"> // 对于数组</span></span></code></pre></div><ul><li><p>获取值 JSON_VALUE</p><blockquote><p>从 JSON 字符串中提取标量值。不能获取对象。</p><p><code>JSON_VALUE(&lt;字段或设置的变量&gt;,&#39;&lt;path&gt;&#39;)</code></p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">json_value(@jsonInfo,&#39;$&#39;)							null</span></span>
<span class="line"><span style="color:#A6ACCD;">json_value(@jsonInfo,&#39;$.info.type&#39;)		N&#39;1&#39;</span></span></code></pre></div></li><li><p>获取对象 JSON_QUERY</p><blockquote><p>从 JSON 字符串中提取对象或数组。不能获取值。</p><p><code>JSON_QUERY(&lt;字段或设置的变量&gt;,&#39;&lt;path&gt;&#39;)</code></p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">json_query(@jsonInfo,&#39;$.info.type&#39;)  	null</span></span>
<span class="line"><span style="color:#A6ACCD;">json_query(@jsonInfo,&#39;$&#39;)							返回整个 JSON 文本。</span></span>
<span class="line"><span style="color:#A6ACCD;">json_query(@jsonInfo,&#39;$.info.tags&#39;)  	N&#39;[ &quot;Sport&quot;, &quot;Water polo&quot;]&#39;</span></span></code></pre></div></li><li><p>数组读取</p><blockquote><p>对于数组读取，可以使用OPENJSON，或使用 <code>$[0].xxx</code>方式获取</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">DECLARE @jsonInfo NVARCHAR(MAX)</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">SET @jsonInfo=N&#39;[{  </span></span>
<span class="line"><span style="color:#A6ACCD;">     &quot;info&quot;:{    </span></span>
<span class="line"><span style="color:#A6ACCD;">       &quot;type&quot;:1,  </span></span>
...
<span class="line"><span style="color:#A6ACCD;">                temp int)</span></span></code></pre></div></li></ul><h3 id="修改-json-的值" tabindex="-1">修改 json 的值 <a class="header-anchor" href="#修改-json-的值" aria-label="Permalink to &quot;修改 json 的值&quot;">​</a></h3><blockquote><p>JSON_MODIFY ( expression , path , newValue )</p></blockquote><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">DECLARE @info NVARCHAR(100)=&#39;{&quot;name&quot;:&quot;John&quot;,&quot;skills&quot;:[&quot;C#&quot;,&quot;SQL&quot;]}&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &quot;surname&quot;: &quot;Smith&quot;</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div>`,10),e=[l];function p(c,u,i,r,C,A){return n(),a("div",null,e)}const d=s(o,[["render",p]]);export{y as __pageData,d as default};
