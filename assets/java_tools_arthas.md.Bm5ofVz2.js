import{at as e,bt as t,o as n,ot as r}from"./chunks/framework.D9EW6sZo.js";var i=JSON.parse(`{"title":"arthas 诊断工具","description":"","frontmatter":{"title":"arthas 诊断工具"},"headers":[],"relativePath":"java/tools/arthas.md","filePath":"java/tools/arthas.md","lastUpdated":1787139859000}`),a={name:`java/tools/arthas.md`};function o(n,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[r(`<blockquote><p><a href="https://arthas.aliyun.com/zh-cn/" target="_blank" rel="noreferrer">Arthas 应用诊断利器 (aliyun.com)</a></p><p><a href="https://github.com/alibaba/arthas" target="_blank" rel="noreferrer">alibaba/arthas: Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas (github.com)</a></p></blockquote><h3 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to “备忘单”">​</a></h3><h4 id="基础命令" tabindex="-1">基础命令 <a class="header-anchor" href="#基础命令" aria-label="Permalink to “基础命令”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 启动</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># 清空当前屏幕区域</span></span>
...
<span class="line"><span>stop</span></span></code></pre></div><h4 id="jvm相关" tabindex="-1">jvm相关 <a class="header-anchor" href="#jvm相关" aria-label="Permalink to “jvm相关”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 线程相关</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span># 查看 JVM 内存信息</span></span>
...
<span class="line"><span>vmtool --action getInstances --className java.lang.String --limit 10</span></span></code></pre></div><h4 id="class-classloader相关" tabindex="-1">class/classloader相关 <a class="header-anchor" href="#class-classloader相关" aria-label="Permalink to “class/classloader相关”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>234# 模糊搜索</span></span>
...
<span class="line"><span>classloader -t</span></span></code></pre></div><h4 id="监控相关" tabindex="-1">监控相关 <a class="header-anchor" href="#监控相关" aria-label="Permalink to “监控相关”">​</a></h4><blockquote><p>请注意，这些命令，都通过字节码增强技术来实现的，会在指定类的方法中插入一些切面来实现数据统计和观测，因此在线上、预发使用时，请尽量明确需要观测的类、方法以及条件，诊断结束要执行 <code>stop</code> 或将增强过的类执行 <code>reset</code> 命令</p></blockquote><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 监控方法执行情况</span></span>
...
<span class="line"><span>stack demo.MathGame primeFactors &#39;#cost&gt;5&#39;</span></span></code></pre></div><h4 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to “其他”">​</a></h4><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 更新 logger level</span></span>
<span class="line"><span>logger --name ROOT --level debug</span></span>
<span class="line"><span>指定 classloader 更新 logger level</span></span>
<span class="line"><span>logger -c 2a139a55 --name ROOT --level debug</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 获取接口的响应时间</span></span>
<span class="line"><span>watch org.springframework.web.servlet.DispatcherServlet doService &#39;{params[0].getRequestURI()+&quot; &quot;+ #cost}&#39;  -n 5  -x 3 &#39;#cost&gt;100&#39;  -f</span></span>
<span class="line"><span># 获取指定header 头的信息</span></span>
<span class="line"><span> watch org.springframework.web.servlet.DispatcherServlet doService &#39;{params[0].getRequestURI()+&quot;  header=&quot;+params[1].getHeaders(&quot;x-trace-id&quot;)}&#39;  -n 10  -x 3  -f</span></span>
<span class="line"><span> </span></span>
<span class="line"><span># 简单查看 sql 语句</span></span>
<span class="line"><span># watch Connection</span></span>
<span class="line"><span>watch java.sql.Connection prepareStatement &#39;{params,throwExp}&#39;  -n 5  -x 3 </span></span>
<span class="line"><span># watch BoundSql(mybatis)</span></span>
<span class="line"><span>watch org.apache.ibatis.mapping.BoundSql getSql &#39;{params,returnObj,throwExp}&#39;  -n 5  -x 3</span></span></code></pre></div><h4 id="ognl" tabindex="-1">ognl <a class="header-anchor" href="#ognl" aria-label="Permalink to “ognl”">​</a></h4><p>可以在表达式中直接使用</p><table tabindex="0"><thead><tr><th>变量名</th><th>变量解释</th></tr></thead><tbody><tr><td>loader</td><td>本次调用类所在的 ClassLoader</td></tr><tr><td>clazz</td><td>本次调用类的 Class 引用</td></tr><tr><td>method</td><td>本次调用方法反射引用</td></tr><tr><td>target</td><td>本次调用类的实例</td></tr><tr><td>params</td><td>本次调用参数列表，这是一个数组，如果方法是无参方法则为空数组</td></tr><tr><td>returnObj</td><td>本次调用返回的对象。当且仅当 <code>isReturn==true</code> 成立时候有效，表明方法调用是以正常返回的方式结束。如果当前方法无返回值 <code>void</code>，则值为 null</td></tr><tr><td>throwExp</td><td>本次调用抛出的异常。当且仅当 <code>isThrow==true</code> 成立时有效，表明方法调用是以抛出异常的方式结束。</td></tr><tr><td>isBefore</td><td>辅助判断标记，当前的通知节点有可能是在方法一开始就通知，此时 <code>isBefore==true</code> 成立，同时 <code>isThrow==false</code> 和 <code>isReturn==false</code>，因为在方法刚开始时，还无法确定方法调用将会如何结束。</td></tr><tr><td>isThrow</td><td>辅助判断标记，当前的方法调用以抛异常的形式结束。</td></tr><tr><td>isReturn</td><td>辅助判断标记，当前的方法调用以正常返回的形式结束。</td></tr></tbody></table><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 查看第一个参数</span></span>
...
<span class="line"><span>#bean=#springContext.getBean(&quot;beanName&quot;)&#39;.CGLIB$CALLBACK_0.advised.targetSource.target \` -c 11531931 -x 2</span></span></code></pre></div>`,17)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};