import{_ as n,c as a,o as l,b as s,a as p}from"./app.a840672a.js";const h=JSON.parse('{"title":"alertmanager","description":"","frontmatter":{"title":"alertmanager"},"headers":[{"level":2,"title":"配置","slug":"配置","link":"#配置","children":[{"level":3,"title":"通用配置","slug":"通用配置","link":"#通用配置","children":[]},{"level":3,"title":"路由配置","slug":"路由配置","link":"#路由配置","children":[]},{"level":3,"title":"接收者配置","slug":"接收者配置","link":"#接收者配置","children":[{"level":4,"title":"email接收","slug":"email接收","link":"#email接收","children":[]},{"level":4,"title":"企业微信通知","slug":"企业微信通知","link":"#企业微信通知","children":[]},{"level":4,"title":"http回调","slug":"http回调","link":"#http回调","children":[]}]}]}],"relativePath":"ops/prometheus/alertmanager.md","lastUpdated":1678341619000}'),t={name:"ops/prometheus/alertmanager.md"},e=s("blockquote",null,[s("p",null,"Prometheus 中的报警发送给 alertmanager . 在通过分组,过滤,抑制后发送给不同的通知接收器的列表")],-1),o=s("iframe",{id:"embed_dom",name:"embed_dom",frameborder:"0",style:{display:"block",width:"725px",height:"245px"},src:"https://www.processon.com/embed/60e579a51e08530a5074c834"},null,-1),c=p(`<h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-hidden="true">#</a></h2><h3 id="通用配置" tabindex="-1">通用配置 <a class="header-anchor" href="#通用配置" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">global:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  ]</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,18),i=[e,o,c];function r(C,A,g,y,u,D){return l(),a("div",null,i)}const _=n(t,[["render",r]]);export{h as __pageData,_ as default};
