import{_ as s,o as n,c as p,ah as e}from"./chunks/framework.BM5zFche.js";const m=JSON.parse('{"title":"arthas 诊断工具","description":"","frontmatter":{"title":"arthas 诊断工具"},"headers":[],"relativePath":"java/tools/arthas.md","filePath":"java/tools/arthas.md","lastUpdated":1784602594000}'),l={name:"java/tools/arthas.md"};function t(i,a,c,o,r,d){return n(),p("div",null,[...a[0]||(a[0]=[e(`<blockquote><p><a href="https://arthas.aliyun.com/zh-cn/" target="_blank" rel="noreferrer">Arthas 应用诊断利器 (aliyun.com)</a></p><p><a href="https://github.com/alibaba/arthas" target="_blank" rel="noreferrer">alibaba/arthas: Alibaba Java Diagnostic Tool Arthas/Alibaba Java诊断利器Arthas (github.com)</a></p></blockquote><h3 id="备忘单" tabindex="-1">备忘单 <a class="header-anchor" href="#备忘单" aria-label="Permalink to &quot;备忘单&quot;">​</a></h3><h4 id="基础命令" tabindex="-1">基础命令 <a class="header-anchor" href="#基础命令" aria-label="Permalink to &quot;基础命令&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 启动</span></span>
...
<span class="line"><span>stop</span></span></code></pre></div><h4 id="jvm相关" tabindex="-1">jvm相关 <a class="header-anchor" href="#jvm相关" aria-label="Permalink to &quot;jvm相关&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 线程相关</span></span>
...
<span class="line"><span>vmtool --action getInstances --className java.lang.String --limit 10</span></span></code></pre></div><h4 id="class-classloader相关" tabindex="-1">class/classloader相关 <a class="header-anchor" href="#class-classloader相关" aria-label="Permalink to &quot;class/classloader相关&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>234# 模糊搜索</span></span>
...
<span class="line"><span>classloader -t</span></span></code></pre></div><h4 id="监控相关" tabindex="-1">监控相关 <a class="header-anchor" href="#监控相关" aria-label="Permalink to &quot;监控相关&quot;">​</a></h4><blockquote><p>请注意，这些命令，都通过字节码增强技术来实现的，会在指定类的方法中插入一些切面来实现数据统计和观测，因此在线上、预发使用时，请尽量明确需要观测的类、方法以及条件，诊断结束要执行 <code>stop</code> 或将增强过的类执行 <code>reset</code> 命令</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 监控方法执行情况</span></span>
...
<span class="line"><span>stack demo.MathGame primeFactors &#39;#cost&gt;5&#39;</span></span></code></pre></div><h4 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to &quot;其他&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 更新 logger level</span></span>
...
<span class="line"><span>#bean=#springContext.getBean(&quot;beanName&quot;)&#39;.CGLIB$CALLBACK_0.advised.targetSource.target \` -c 11531931 -x 2</span></span></code></pre></div>`,17)])])}const u=s(l,[["render",t]]);export{m as __pageData,u as default};
