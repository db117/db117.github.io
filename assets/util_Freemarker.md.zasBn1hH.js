import{_ as a,o as n,c as p,ah as e}from"./chunks/framework.CZP_9SSd.js";const h=JSON.parse('{"title":"Freemarker","description":"","frontmatter":{"title":"Freemarker"},"headers":[],"relativePath":"util/Freemarker.md","filePath":"util/Freemarker.md","lastUpdated":1779088264000}'),l={name:"util/Freemarker.md"};function t(i,s,c,o,u,r){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h2 id="基础语法" tabindex="-1">基础语法 <a class="header-anchor" href="#基础语法" aria-label="Permalink to &quot;基础语法&quot;">​</a></h2><h3 id="字符输出" tabindex="-1">字符输出 <a class="header-anchor" href="#字符输出" aria-label="Permalink to &quot;字符输出&quot;">​</a></h3><ul><li><p>变量存在，输出该变量，否则不输出 <code>\${emp.name?if_exists} </code></p></li><li><p>变量存在，输出该变量，否则不输出</p><pre><code>\${emp.name!}
...
<span class="line"><span>  // 方法1\${str?substring(0,4)}</span><span> // 输出abcd</span></span>
<span class="line"><span>  // 方法2\${str[0]}\${str[4]}</span><span> // 结果是ae</span></span>
...
<span class="line"><span>#{y; M2}</span><span> // 输出4</span></span>
<span class="line"><span>#{x; m2}</span><span> // 输出2.58</span></span>
<span class="line"><span>#{y; m2}</span><span> // 输出4.0</span></span>
<span class="line"><span>#{x; m1M2}</span><span> // 输出2.58</span></span>
<span class="line"><span>#{x; m1M2}</span><span> // 输出4.0</span></span></code></pre></div><h3 id="比较运算符" tabindex="-1">比较运算符 <a class="header-anchor" href="#比较运算符" aria-label="Permalink to &quot;比较运算符&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>= 或 == ：判断两个值是否相等.</span></span>
...
<span class="line"><span>\${r&quot;C:/foo/bar&quot;}    // 输出 C:/foo/bar</span></span>
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span># HTML 特殊字符</span></span>
<span class="line"><span>\${str?html}</span></span>
<span class="line"><span></span></span>
<span class="line"><span># JavaScript 特殊字符</span></span>
<span class="line"><span>\${str?js_string}</span></span>
<span class="line"><span></span></span>
<span class="line"><span># 不会在这个指令体中间寻找FTL标签</span></span>
<span class="line"><span>&lt;#noparse&gt;\${str}&lt;/#noparse&gt;</span></span></code></pre></div><h3 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to &quot;其他&quot;">​</a></h3><h4 id="include指令" tabindex="-1">include指令 <a class="header-anchor" href="#include指令" aria-label="Permalink to &quot;include指令&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// include指令的作用类似于JSP的包含指令:</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>&lt;#nt&gt;// 取消上面的效果</span></span></code></pre></div>`,32)])])}const g=a(l,[["render",t]]);export{h as __pageData,g as default};
