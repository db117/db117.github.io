import{_ as e,o as a,c as n,ah as p}from"./chunks/framework.BM5zFche.js";const g=JSON.parse('{"title":"sql 语句执行顺序","description":"","frontmatter":{"title":"sql 语句执行顺序"},"headers":[],"relativePath":"infrastructure/database/sql-exec-seq.md","filePath":"infrastructure/database/sql-exec-seq.md","lastUpdated":1784602594000}'),l={name:"infrastructure/database/sql-exec-seq.md"};function c(o,s,t,i,d,r){return a(),n("div",null,[...s[0]||(s[0]=[p(`<blockquote><p>常用的 sql 中大致执行顺序</p><p>每一步都生成一个虚拟的表，供后面的表使用。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>(8) SELECT (9)DISTINCT&lt;Select_list&gt;</span></span>
...
<span class="line"><span>相当于</span></span>
<span class="line"><span>group by 1,2,3 +group by 1 + group by 2 + group by 3 + group by 1,2 + group by 1,3 + group by 2,3</span></span></code></pre></div></li></ul></li><li><p><code>having</code> 对分组后的数据进行筛选</p></li><li><p><code>select</code> 把需要的列筛选出来，过滤掉不需要的列</p></li><li><p><code>distinct</code> 把重复的数据进行剔除</p></li><li><p><code>order by</code> 对数据进行排序</p></li><li><p><code>limit</code>：选择指定行</p></li></ul>`,3)])])}const b=e(l,[["render",c]]);export{g as __pageData,b as default};
