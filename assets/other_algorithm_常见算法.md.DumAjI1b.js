import{_ as s,c as a,a3 as p,o as l}from"./chunks/framework.B112ehe2.js";const h=JSON.parse('{"title":"常见算法","description":"","frontmatter":{"title":"常见算法"},"headers":[],"relativePath":"other/algorithm/常见算法.md","filePath":"other/algorithm/常见算法.md"}'),e={name:"other/algorithm/常见算法.md"};function i(t,n,c,o,r,d){return l(),a("div",null,n[0]||(n[0]=[p(`<h3 id="蓄水池抽样算法-reservoir-sampling" tabindex="-1">蓄水池抽样算法（Reservoir Sampling） <a class="header-anchor" href="#蓄水池抽样算法-reservoir-sampling" aria-label="Permalink to &quot;蓄水池抽样算法（Reservoir Sampling）&quot;">​</a></h3><blockquote><p><strong>给定一个数据流，数据流长度N很大，且N直到处理完所有数据之前都不可知，请问如何在只遍历一遍数据（O(N)）的情况下，能够随机选取出K个不重复的数据。</strong></p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>int[] result = new int[K];</span></span>
